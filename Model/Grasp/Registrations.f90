module Registrations
   ...
   contains
      ...
      subroutine doRegistrations(id)
         ...
         dummy = add_reg(respondToGetSetReg, 'plant_status', stringTypeDDML, ' ', 'Plant status')
         ...
         dummy = add_reg(respondToGetSetReg, 'cover_tot', floatTypeDDML, ' ', 'Total cover')
         dummy = add_reg(respondToGetSetReg, 'cover_green', floatTypeDDML, ' ', 'Green cover')
         ...
         dummy = add_reg(respondToGetSetReg, 'dlt_dm', floatTypeDDML, 'g/m^2', '')
         ...
         dummy = add_reg(respondToGetSetReg, 'n_uptake', floatTypeDDML, 'kg/ha', '')
