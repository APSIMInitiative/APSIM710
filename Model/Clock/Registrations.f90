module Registrations
   ...
   contains
      ...
      subroutine doRegistrations(id)
         ...
         id%dummy = add_reg(respondToGetReg, 'is_start_week', booleanTypeDDML, '', 'Whether today is the start of the week')
         id%dummy = add_reg(respondToGetReg, 'is_end_week', booleanTypeDDML, '', 'Whether today is the end of the week')
         id%dummy = add_reg(respondToGetReg, 'is_start_month', booleanTypeDDML, '', 'Whether today is the start of the month')
         id%dummy = add_reg(respondToGetReg, 'is_end_month', booleanTypeDDML, '', 'Whether today is the end of the month')
         id%dummy = add_reg(respondToGetReg, 'is_end_year', booleanTypeDDML, '', 'Whether today is the end of the year')
         id%dummy = add_reg(respondToGetReg, 'is_start_simulation', booleanTypeDDML, '', 'Whether today is the start of the simulation')
         id%dummy = add_reg(respondToGetReg, 'is_end_simulation', booleanTypeDDML, '', 'Whether today is the end of the simulation')
         ...
         id%dummy = add_reg(respondToGetReg, 'simulation_start_date', intTypeDDML, '', 'Date of start of simulation')
         id%dummy = add_reg(respondToGetReg, 'simulation_end_date', intTypeDDML, '', 'Date of end of simulation')
         id%dummy = add_reg(respondToGetReg, 'today', intTypeDDML, '', '')
         ...
         id%dummy = add_reg(respondToGetReg, 'dd_mmm_yyyy', stringTypeDDML, 'dd_mmm_yyyy', '')
