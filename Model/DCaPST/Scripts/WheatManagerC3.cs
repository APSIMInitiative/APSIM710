...
{      
   ...
   [EventHandler] public void Ondodcapst() 
   {
      ...
      // OPTIONAL VALUES:      
      // Switch to print extra data
      DM.PrintIntervalValues = false; // default = false
      ...
      if (!empty)
      {
         writer.Write("yield return new TestCaseData(");
         writer.Write(DOY + ",");
         writer.Write(latitude + ",");
         writer.Write(maxT + ",");
         writer.Write(minT + ",");
         writer.Write(radn + ",");
         writer.Write(RootShootRatio + ",");
         writer.Write(greenN + ",");
         writer.Write(SWAvailable + ",");
         writer.Write(lai + ",");
         writer.Write(DM.ActualBiomass + ",");
         writer.Write(DM.WaterDemanded + ",");
         writer.Write(DM.WaterSupplied + ",");
         writer.Write(DM.InterceptedRadiation + ",");
         writer.Write(DM.PotentialBiomass + ");\n");
