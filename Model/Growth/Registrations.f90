module Registrations
   ...
   contains
    ...
    ! variables we own and make available to other modules (gettable)
         ...
         dummy = add_reg(respondToGetReg, 'fd', floatTypeDDML, '0-1', '')   
         dummy = add_reg(respondToGetReg, 'foliage_n_conc', floatTypeDDML, 'g/g', '')   
         dummy = add_reg(respondToGetReg, 'retranslocation_fract', floatTypeDDML, '', '')   
