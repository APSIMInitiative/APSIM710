...
//
// C:\DOCUME~1\zur003\LOCALS~1\Temp\mscorlib.tlh
//
...
IList : IDispatch
{
    ...
    __declspec(property(get=GetIsFixedSize))
    VARIANT_BOOL IsFixedSize;
...
IDeserializationCallback : IDispatch
{
    ...
    //
      ...
      virtual HRESULT __stdcall raw_OnDeserialization (
        /*[in]*/ VARIANT sender ) = 0;
};
...
IAppDomainSetup : IUnknown
{
    ...
    __declspec(property(get=GetApplicationBase,put=PutApplicationBase))
    _bstr_t ApplicationBase;
    __declspec(property(get=GetApplicationName,put=PutApplicationName))
    _bstr_t ApplicationName;
    __declspec(property(get=GetCachePath,put=PutCachePath))
    _bstr_t CachePath;
    __declspec(property(get=GetConfigurationFile,put=PutConfigurationFile))
    _bstr_t ConfigurationFile;
    __declspec(property(get=GetDynamicBase,put=PutDynamicBase))
    _bstr_t DynamicBase;
    __declspec(property(get=GetLicenseFile,put=PutLicenseFile))
    _bstr_t LicenseFile;
    __declspec(property(get=GetPrivateBinPath,put=PutPrivateBinPath))
    _bstr_t PrivateBinPath;
    __declspec(property(get=GetPrivateBinPathProbe,put=PutPrivateBinPathProbe))
    _bstr_t PrivateBinPathProbe;
    __declspec(property(get=GetShadowCopyDirectories,put=PutShadowCopyDirectories))
    _bstr_t ShadowCopyDirectories;
    __declspec(property(get=GetShadowCopyFiles,put=PutShadowCopyFiles))
    _bstr_t ShadowCopyFiles;

    //
    // Wrapper methods for error-handling
    //

    _bstr_t GetApplicationBase ( );
    void PutApplicationBase (
        _bstr_t pRetVal );
    _bstr_t GetApplicationName ( );
    void PutApplicationName (
        _bstr_t pRetVal );
    _bstr_t GetCachePath ( );
    void PutCachePath (
        _bstr_t pRetVal );
    _bstr_t GetConfigurationFile ( );
    void PutConfigurationFile (
        _bstr_t pRetVal );
    _bstr_t GetDynamicBase ( );
    void PutDynamicBase (
        _bstr_t pRetVal );
    _bstr_t GetLicenseFile ( );
    void PutLicenseFile (
        _bstr_t pRetVal );
    _bstr_t GetPrivateBinPath ( );
    void PutPrivateBinPath (
        _bstr_t pRetVal );
    _bstr_t GetPrivateBinPathProbe ( );
    void PutPrivateBinPathProbe (
        _bstr_t pRetVal );
    _bstr_t GetShadowCopyDirectories ( );
    void PutShadowCopyDirectories (
        _bstr_t pRetVal );
    _bstr_t GetShadowCopyFiles ( );
    void PutShadowCopyFiles (
        _bstr_t pRetVal );
...
IDictionaryEnumerator : IDispatch
{
    ...
    _variant_t value;
    __declspec(property(get=GetEntry))
    ...
    _variant_t Getkey ( );
    _variant_t Getvalue ( );
    struct DictionaryEntry GetEntry ( );
...
ISymbolDocument : IDispatch
{
    ...
    GUID Language;
    __declspec(property(get=GetLanguageVendor))
    GUID LanguageVendor;
    __declspec(property(get=GetCheckSumAlgorithmId))
    GUID CheckSumAlgorithmId;
    __declspec(property(get=GetHasEmbeddedSource))
    VARIANT_BOOL HasEmbeddedSource;
    __declspec(property(get=GetSourceLength))
    long SourceLength;
    ...
    SAFEARRAY * GetCheckSum ( );
    long FindClosestLine (
        long line );
    VARIANT_BOOL GetHasEmbeddedSource ( );
    long GetSourceLength ( );
    SAFEARRAY * GetSourceRange (
        long startLine,
        long startColumn,
        long endLine,
        long endColumn );
    ...
    //
      ...
      virtual HRESULT __stdcall get_CheckSumAlgorithmId (
        /*[out,retval]*/ GUID * pRetVal ) = 0;
      virtual HRESULT __stdcall raw_GetCheckSum (
        /*[out,retval]*/ SAFEARRAY * * pRetVal ) = 0;
      virtual HRESULT __stdcall raw_FindClosestLine (
        /*[in]*/ long line,
        /*[out,retval]*/ long * pRetVal ) = 0;
...
ISymbolDocumentWriter : IDispatch
{
    ...
    //
      ...
      virtual HRESULT __stdcall raw_SetCheckSum (
        /*[in]*/ GUID algorithmId,
...
ISymbolNamespace : IDispatch
{
    ...
    _bstr_t Getname ( );
    SAFEARRAY * GetNamespaces ( );
    SAFEARRAY * GetVariables ( );
    ...
    //
      ...
      virtual HRESULT __stdcall get_name (
        /*[out,retval]*/ BSTR * pRetVal ) = 0;
      virtual HRESULT __stdcall raw_GetNamespaces (
        /*[out,retval]*/ SAFEARRAY * * pRetVal ) = 0;
      virtual HRESULT __stdcall raw_GetVariables (
        /*[out,retval]*/ SAFEARRAY * * pRetVal ) = 0;
};
...
ISymbolVariable : IDispatch
{
    ...
    __declspec(property(get=GetAddressKind))
    enum SymAddressKind AddressKind;
    __declspec(property(get=GetAddressField1))
    long AddressField1;
    __declspec(property(get=GetAddressField2))
    long AddressField2;
    __declspec(property(get=GetAddressField3))
    long AddressField3;
    __declspec(property(get=GetStartOffset))
    long StartOffset;
    __declspec(property(get=GetEndOffset))
    long EndOffset;
    ...
    SAFEARRAY * GetSignature ( );
    enum SymAddressKind GetAddressKind ( );
    long GetAddressField1 ( );
    long GetAddressField2 ( );
    long GetAddressField3 ( );
    long GetStartOffset ( );
    long GetEndOffset ( );
    ...
    //
      ...
      virtual HRESULT __stdcall get_Attributes (
        /*[out,retval]*/ VARIANT * pRetVal ) = 0;
      virtual HRESULT __stdcall raw_GetSignature (
        /*[out,retval]*/ SAFEARRAY * * pRetVal ) = 0;
...
ISymbolWriter : IDispatch
{
    ...
    ISymbolDocumentWriterPtr DefineDocument (
        _bstr_t Url,
        GUID Language,
        GUID LanguageVendor,
        GUID DocumentType );
    ...
    HRESULT OpenMethod (
        struct SymbolToken Method );
    HRESULT CloseMethod ( );
    HRESULT DefineSequencePoints (
        struct ISymbolDocumentWriter * document,
        SAFEARRAY * offsets,
        SAFEARRAY * lines,
        SAFEARRAY * columns,
        SAFEARRAY * endLines,
    ...
    HRESULT DefineLocalVariable (
        _bstr_t name,
        enum FieldAttributes Attributes,
        SAFEARRAY * signature,
        enum SymAddressKind addrKind,
        long addr1,
        long addr2,
        long addr3,
        long StartOffset,
    ...
    HRESULT DefineParameter (
        _bstr_t name,
        enum ParameterAttributes Attributes,
        long sequence,
        enum SymAddressKind addrKind,
        long addr1,
        long addr2,
    ...
    HRESULT SetMethodSourceRange (
        struct ISymbolDocumentWriter * startDoc,
        long startLine,
        long startColumn,
        struct ISymbolDocumentWriter * endDoc,
        long endLine,
        long endColumn );
    HRESULT SetUnderlyingWriter (
        long underlyingWriter );
    ...
    //
      ...
      virtual HRESULT __stdcall raw_DefineDocument (
        /*[in]*/ BSTR Url,
        /*[in]*/ GUID Language,
        /*[in]*/ GUID LanguageVendor,
        /*[in]*/ GUID DocumentType,
        /*[out,retval]*/ struct ISymbolDocumentWriter * * pRetVal ) = 0;
      virtual HRESULT __stdcall raw_SetUserEntryPoint (
        /*[in]*/ struct SymbolToken entryMethod ) = 0;
      virtual HRESULT __stdcall raw_OpenMethod (
        /*[in]*/ struct SymbolToken Method ) = 0;
      virtual HRESULT __stdcall raw_CloseMethod ( ) = 0;
      virtual HRESULT __stdcall raw_DefineSequencePoints (
      ...
      virtual HRESULT __stdcall raw_OpenScope (
        /*[in]*/ long StartOffset,
        /*[out,retval]*/ long * pRetVal ) = 0;
      virtual HRESULT __stdcall raw_CloseScope (
        /*[in]*/ long EndOffset ) = 0;
      virtual HRESULT __stdcall raw_SetScopeRange (
        /*[in]*/ long scopeID,
        /*[in]*/ long StartOffset,
        /*[in]*/ long EndOffset ) = 0;
      virtual HRESULT __stdcall raw_DefineLocalVariable (
        /*[in]*/ BSTR name,
        ...
        /*[in]*/ long StartOffset,
        /*[in]*/ long EndOffset ) = 0;
      virtual HRESULT __stdcall raw_DefineParameter (
        /*[in]*/ BSTR name,
        ...
        /*[in]*/ long addr2,
        /*[in]*/ long addr3 ) = 0;
      virtual HRESULT __stdcall raw_DefineField (
        ...
        /*[in]*/ long addr2,
        /*[in]*/ long addr3 ) = 0;
      virtual HRESULT __stdcall raw_DefineGlobalVariable (
        /*[in]*/ BSTR name,
        /*[in]*/ enum FieldAttributes Attributes,
        /*[in]*/ SAFEARRAY * signature,
        /*[in]*/ enum SymAddressKind addrKind,
      ...
      virtual HRESULT __stdcall raw_SetSymAttribute (
        /*[in]*/ struct SymbolToken parent,
        /*[in]*/ BSTR name,
        /*[in]*/ SAFEARRAY * data ) = 0;
      virtual HRESULT __stdcall raw_OpenNamespace (
        /*[in]*/ BSTR name ) = 0;
      virtual HRESULT __stdcall raw_CloseNamespace ( ) = 0;
      virtual HRESULT __stdcall raw_UsingNamespace (
        /*[in]*/ BSTR FullName ) = 0;
      virtual HRESULT __stdcall raw_SetMethodSourceRange (
        ...
        /*[in]*/ long endLine,
        /*[in]*/ long endColumn ) = 0;
      virtual HRESULT __stdcall raw_SetUnderlyingWriter (
...
IObjectReference : IDispatch
{
    ...
    //
      ...
      virtual HRESULT __stdcall raw_GetRealObject (
...
IResourceReader : IDispatch
{
    ...
    HRESULT Close ( );
    IDictionaryEnumeratorPtr GetEnumerator ( );
...
IResourceWriter : IDispatch
{
    ...
    HRESULT AddResource (
        _bstr_t name,
        _bstr_t value );
    HRESULT AddResource_2 (
        _bstr_t name,
        const _variant_t & value );
    HRESULT AddResource_3 (
        _bstr_t name,
        SAFEARRAY * value );
    HRESULT Close ( );
    HRESULT Generate ( );
    ...
    //
      ...
      virtual HRESULT __stdcall raw_AddResource (
        /*[in]*/ BSTR name,
        /*[in]*/ BSTR value ) = 0;
      virtual HRESULT __stdcall raw_AddResource_2 (
        /*[in]*/ BSTR name,
        /*[in]*/ VARIANT value ) = 0;
      virtual HRESULT __stdcall raw_AddResource_3 (
        /*[in]*/ BSTR name,
        /*[in]*/ SAFEARRAY * value ) = 0;
      virtual HRESULT __stdcall raw_Close ( ) = 0;
      virtual HRESULT __stdcall raw_Generate ( ) = 0;
};
...
IIdentity : IDispatch
{
    ...
    _bstr_t AuthenticationType;
    __declspec(property(get=GetIsAuthenticated))
    VARIANT_BOOL IsAuthenticated;
    ...
    _bstr_t Getname ( );
    _bstr_t GetAuthenticationType ( );
    VARIANT_BOOL GetIsAuthenticated ( );
...
IPrincipal : IDispatch
{
    ...
    __declspec(property(get=GetIdentity))
    ...
    IIdentityPtr GetIdentity ( );
    VARIANT_BOOL IsInRole (
        _bstr_t role );
    ...
    //
      ...
      virtual HRESULT __stdcall raw_IsInRole (
        /*[in]*/ BSTR role,
        /*[out,retval]*/ VARIANT_BOOL * pRetVal ) = 0;
};
...
ICustomMarshaler : IDispatch
{
    ...
    _variant_t MarshalNativeToManaged (
        long pNativeData );
    long MarshalManagedToNative (
        const _variant_t & ManagedObj );
    HRESULT CleanUpNativeData (
        long pNativeData );
    HRESULT CleanUpManagedData (
        const _variant_t & ManagedObj );
    long GetNativeDataSize ( );

    //
    // Raw methods provided by interface
    //

      virtual HRESULT __stdcall raw_MarshalNativeToManaged (
        /*[in]*/ long pNativeData,
        /*[out,retval]*/ VARIANT * pRetVal ) = 0;
      virtual HRESULT __stdcall raw_MarshalManagedToNative (
        /*[in]*/ VARIANT ManagedObj,
        /*[out,retval]*/ long * pRetVal ) = 0;
      virtual HRESULT __stdcall raw_CleanUpNativeData (
        /*[in]*/ long pNativeData ) = 0;
      virtual HRESULT __stdcall raw_CleanUpManagedData (
        /*[in]*/ VARIANT ManagedObj ) = 0;
      virtual HRESULT __stdcall raw_GetNativeDataSize (
        /*[out,retval]*/ long * pRetVal ) = 0;
};
...
ICustomAdapter : IDispatch
{
    ...
    IUnknownPtr GetUnderlyingObject ( );

    //
    // Raw methods provided by interface
    //

      virtual HRESULT __stdcall raw_GetUnderlyingObject (
...
IPermission : IDispatch
{
    ...
    IPermissionPtr Copy ( );
    IPermissionPtr Intersect (
        struct IPermission * Target );
    IPermissionPtr Union (
        struct IPermission * Target );
    VARIANT_BOOL IsSubsetOf (
        struct IPermission * Target );
    HRESULT Demand ( );
    ...
    //
      ...
      virtual HRESULT __stdcall raw_Union (
        /*[in]*/ struct IPermission * Target,
        /*[out,retval]*/ struct IPermission * * pRetVal ) = 0;
      virtual HRESULT __stdcall raw_IsSubsetOf (
        /*[in]*/ struct IPermission * Target,
        /*[out,retval]*/ VARIANT_BOOL * pRetVal ) = 0;
      virtual HRESULT __stdcall raw_Demand ( ) = 0;
};
...
IStackWalk : IDispatch
{
    ...
    //
      ...
      virtual HRESULT __stdcall raw_Assert ( ) = 0;
      virtual HRESULT __stdcall raw_Demand ( ) = 0;
      virtual HRESULT __stdcall raw_Deny ( ) = 0;
      virtual HRESULT __stdcall raw_PermitOnly ( ) = 0;
};
...
IUnrestrictedPermission : IDispatch
{
    ...
    VARIANT_BOOL IsUnrestricted ( );

    //
    // Raw methods provided by interface
    //

      virtual HRESULT __stdcall raw_IsUnrestricted (
        /*[out,retval]*/ VARIANT_BOOL * pRetVal ) = 0;
};
...
IChannel : IDispatch
{
    ...
    __declspec(property(get=GetChannelPriority))
    long ChannelPriority;
...
IChannelReceiver : IDispatch
{
    ...
    __declspec(property(get=GetChannelData))
    _variant_t ChannelData;

    //
    // Wrapper methods for error-handling
    //

    _variant_t GetChannelData ( );
    SAFEARRAY * GetUrlsForUri (
        _bstr_t objectURI );
    ...
    //
      ...
      virtual HRESULT __stdcall get_ChannelData (
        /*[out,retval]*/ VARIANT * pRetVal ) = 0;
      virtual HRESULT __stdcall raw_GetUrlsForUri (
        /*[in]*/ BSTR objectURI,
        /*[out,retval]*/ SAFEARRAY * * pRetVal ) = 0;
...
IMethodCallMessage : IDispatch
{
    ...
    __declspec(property(get=GetInArgCount))
    long InArgCount;
    __declspec(property(get=GetInArgs))
    SAFEARRAY * InArgs;
    ...
    //
      ...
      virtual HRESULT __stdcall get_InArgCount (
        /*[out,retval]*/ long * pRetVal ) = 0;
      virtual HRESULT __stdcall raw_GetInArgName (
        /*[in]*/ long index,
        /*[out,retval]*/ BSTR * pRetVal ) = 0;
      virtual HRESULT __stdcall raw_GetInArg (
        /*[in]*/ long argNum,
        /*[out,retval]*/ VARIANT * pRetVal ) = 0;
...
IChannelDataStore : IDispatch
{
    ...
    __declspec(property(get=GetChannelUris))
    SAFEARRAY * ChannelUris;
    __declspec(property(get=GetItem,put=PutRefItem))
    _variant_t Item[];
...
IFieldInfo : IDispatch
{
    ...
    __declspec(property(get=GetFieldTypes,put=PutFieldTypes))
    SAFEARRAY * FieldTypes;

    //
    // Wrapper methods for error-handling
    //

    SAFEARRAY * GetFieldNames ( );
    void PutFieldNames (
        SAFEARRAY * pRetVal );
    SAFEARRAY * GetFieldTypes ( );
    void PutFieldTypes (
        SAFEARRAY * pRetVal );
...
IChannelInfo : IDispatch
{
    ...
    __declspec(property(get=GetChannelData,put=PutChannelData))
    SAFEARRAY * ChannelData;

    //
    // Wrapper methods for error-handling
    //

    SAFEARRAY * GetChannelData ( );
    void PutChannelData (
        SAFEARRAY * pRetVal );
...
ISoapXsd : IDispatch
{
    ...
    //
      ...
      virtual HRESULT __stdcall raw_GetXsdType (
        /*[out,retval]*/ BSTR * pRetVal ) = 0;
};
...
ISoapMessage : IDispatch
{
    ...
    __declspec(property(get=GetParamNames,put=PutParamNames))
    SAFEARRAY * ParamNames;
    __declspec(property(get=GetParamValues,put=PutParamValues))
    SAFEARRAY * ParamValues;
    __declspec(property(get=GetParamTypes,put=PutParamTypes))
    SAFEARRAY * ParamTypes;
    __declspec(property(get=GetMethodName,put=PutMethodName))
    _bstr_t MethodName;
    __declspec(property(get=GetXmlNameSpace,put=PutXmlNameSpace))
    _bstr_t XmlNameSpace;
    __declspec(property(get=Getheaders,put=Putheaders))
    SAFEARRAY * headers;
    ...
    SAFEARRAY * GetParamNames ( );
    void PutParamNames (
        SAFEARRAY * pRetVal );
    SAFEARRAY * GetParamValues ( );
    void PutParamValues (
        SAFEARRAY * pRetVal );
    SAFEARRAY * GetParamTypes ( );
    void PutParamTypes (
        SAFEARRAY * pRetVal );
    ...
    void PutXmlNameSpace (
        _bstr_t pRetVal );
    SAFEARRAY * Getheaders ( );
    void Putheaders (
        SAFEARRAY * pRetVal );
...
ICryptoTransform : IDispatch
{
    ...
    __declspec(property(get=GetInputBlockSize))
    long InputBlockSize;
    __declspec(property(get=GetOutputBlockSize))
    long OutputBlockSize;
    __declspec(property(get=GetCanTransformMultipleBlocks))
    VARIANT_BOOL CanTransformMultipleBlocks;
    __declspec(property(get=GetCanReuseTransform))
    VARIANT_BOOL CanReuseTransform;

    //
    // Wrapper methods for error-handling
    //

    long GetInputBlockSize ( );
    long GetOutputBlockSize ( );
    VARIANT_BOOL GetCanTransformMultipleBlocks ( );
    VARIANT_BOOL GetCanReuseTransform ( );
    long TransformBlock (
    ...
    //
      ...
      virtual HRESULT __stdcall get_CanReuseTransform (
        /*[out,retval]*/ VARIANT_BOOL * pRetVal ) = 0;
      virtual HRESULT __stdcall raw_TransformBlock (
        ...
        /*[out,retval]*/ long * pRetVal ) = 0;
      virtual HRESULT __stdcall raw_TransformFinalBlock (
        /*[in]*/ SAFEARRAY * inputBuffer,
        /*[in]*/ long inputOffset,
        /*[in]*/ long inputCount,
        /*[out,retval]*/ SAFEARRAY * * pRetVal ) = 0;
...
ICollection : IDispatch
{
    ...
    long Count;
    __declspec(property(get=GetSyncRoot))
    _variant_t SyncRoot;
    __declspec(property(get=GetIsSynchronized))
    ...
    HRESULT CopyTo (
        ...
        long index );
    long GetCount ( );
    _variant_t GetSyncRoot ( );
    VARIANT_BOOL GetIsSynchronized ( );
...
IChannelSinkBase : IDispatch
{
    ...
    IDictionaryPtr Properties;

    //
    // Wrapper methods for error-handling
    //

    IDictionaryPtr GetProperties ( );
...
IMessageSink : IDispatch
{
    ...
    __declspec(property(get=GetNextSink))
    IMessageSinkPtr NextSink;

    //
    // Wrapper methods for error-handling
    //

    IMessagePtr SyncProcessMessage (
        struct IMessage * msg );
    IMessageCtrlPtr AsyncProcessMessage (
        struct IMessage * msg,
        struct IMessageSink * replySink );
    IMessageSinkPtr GetNextSink ( );

    //
    // Raw methods provided by interface
    //

      virtual HRESULT __stdcall raw_SyncProcessMessage (
        /*[in]*/ struct IMessage * msg,
        /*[out,retval]*/ struct IMessage * * pRetVal ) = 0;
      virtual HRESULT __stdcall raw_AsyncProcessMessage (
        /*[in]*/ struct IMessage * msg,
...
IChannelSender : IDispatch
{
    ...
    IMessageSinkPtr CreateMessageSink (
        _bstr_t Url,
        const _variant_t & remoteChannelData,
        BSTR * objectURI );
    ...
    //
      ...
      virtual HRESULT __stdcall raw_CreateMessageSink (
        /*[in]*/ BSTR Url,
...
IContributeClientContextSink : IDispatch
{
    ...
    IMessageSinkPtr GetClientContextSink (
        struct IMessageSink * NextSink );

    //
    // Raw methods provided by interface
    //

      virtual HRESULT __stdcall raw_GetClientContextSink (
...
IContributeServerContextSink : IDispatch
{
    ...
    IMessageSinkPtr GetServerContextSink (
        struct IMessageSink * NextSink );
    ...
    //
      ...
      virtual HRESULT __stdcall raw_GetServerContextSink (
        /*[in]*/ struct IMessageSink * NextSink,
        /*[out,retval]*/ struct IMessageSink * * pRetVal ) = 0;
};
...
IDynamicMessageSink : IDispatch
{
    ...
    HRESULT ProcessMessageStart (
        struct IMessage * reqMsg,
        VARIANT_BOOL bCliSide,
        VARIANT_BOOL bAsync );
    HRESULT ProcessMessageFinish (
        struct IMessage * replyMsg,
        VARIANT_BOOL bCliSide,
        VARIANT_BOOL bAsync );
    ...
    //
      ...
      virtual HRESULT __stdcall raw_ProcessMessageStart (
        /*[in]*/ struct IMessage * reqMsg,
        /*[in]*/ VARIANT_BOOL bCliSide,
        /*[in]*/ VARIANT_BOOL bAsync ) = 0;
      virtual HRESULT __stdcall raw_ProcessMessageFinish (
...
IContributeDynamicSink : IDispatch
{
    ...
    IDynamicMessageSinkPtr GetDynamicSink ( );

    //
    // Raw methods provided by interface
    //

      virtual HRESULT __stdcall raw_GetDynamicSink (
...
IEnvoyInfo : IDispatch
{
    ...
    __declspec(property(get=GetEnvoySinks,put=PutRefEnvoySinks))
    IMessageSinkPtr EnvoySinks;

    //
    // Wrapper methods for error-handling
    //

    IMessageSinkPtr GetEnvoySinks ( );
    void PutRefEnvoySinks (
        struct IMessageSink * pRetVal );
...
IContributeEnvoySink : IDispatch
{
    ...
    IMessageSinkPtr GetEnvoySink (
        struct _MarshalByRefObject * obj,
        struct IMessageSink * NextSink );
    ...
    //
      ...
      virtual HRESULT __stdcall raw_GetEnvoySink (
...
IContributeObjectSink : IDispatch
{
    ...
    //
      ...
      virtual HRESULT __stdcall raw_GetObjectSink (
        /*[in]*/ struct _MarshalByRefObject * obj,
        /*[in]*/ struct IMessageSink * NextSink,
        /*[out,retval]*/ struct IMessageSink * * pRetVal ) = 0;
};
...
IAsyncResult : IDispatch
{
    ...
    __declspec(property(get=GetAsyncWaitHandle))
    _WaitHandlePtr AsyncWaitHandle;
    __declspec(property(get=GetAsyncState))
    _variant_t AsyncState;
    __declspec(property(get=GetCompletedSynchronously))
    VARIANT_BOOL CompletedSynchronously;
    ...
    _WaitHandlePtr GetAsyncWaitHandle ( );
    _variant_t GetAsyncState ( );
    VARIANT_BOOL GetCompletedSynchronously ( );
...
ISerializable : IDispatch
{
    ...
    HRESULT GetObjectData (
        struct _SerializationInfo * info,
        struct StreamingContext Context );
...
IEvidenceFactory : IDispatch
{
    ...
    __declspec(property(get=GetEvidence))
    _EvidencePtr Evidence;
...
IMembershipCondition : IDispatch
{
    ...
    VARIANT_BOOL Check (
        struct _Evidence * Evidence );
    IMembershipConditionPtr Copy ( );
    _bstr_t GetToString ( );
    VARIANT_BOOL Equals (
        const _variant_t & obj );
...
IIdentityPermissionFactory : IDispatch
{
    ...
    IPermissionPtr CreateIdentityPermission (
        struct _Evidence * Evidence );
    ...
    //
      ...
      virtual HRESULT __stdcall raw_CreateIdentityPermission (
        /*[in]*/ struct _Evidence * Evidence,
        /*[out,retval]*/ struct IPermission * * pRetVal ) = 0;
};
...
IApplicationTrustManager : IDispatch
{
    ...
    _ApplicationTrustPtr DetermineApplicationTrust (
        IUnknown * activationContext,
        struct _TrustManagerContext * Context );

    //
    // Raw methods provided by interface
    //

      virtual HRESULT __stdcall raw_DetermineApplicationTrust (
...
IServerResponseChannelSinkStack : IDispatch
{
    ...
    HRESULT AsyncProcessResponse (
        struct IMessage * msg,
        struct ITransportHeaders * headers,
        struct _Stream * Stream );
    _StreamPtr GetResponseStream (
        struct IMessage * msg,
        struct ITransportHeaders * headers );
    ...
    //
      ...
      virtual HRESULT __stdcall raw_AsyncProcessResponse (
        /*[in]*/ struct IMessage * msg,
        /*[in]*/ struct ITransportHeaders * headers,
        /*[in]*/ struct _Stream * Stream ) = 0;
      virtual HRESULT __stdcall raw_GetResponseStream (
        /*[in]*/ struct IMessage * msg,
        /*[in]*/ struct ITransportHeaders * headers,
...
ISecurityEncodable : IDispatch
{
    ...
    _SecurityElementPtr ToXml ( );
    HRESULT FromXml (
        struct _SecurityElement * e );

    //
    // Raw methods provided by interface
    //

      virtual HRESULT __stdcall raw_ToXml (
...
IContextProperty : IDispatch
{
    ...
    _bstr_t Getname ( );
    VARIANT_BOOL IsNewContextOK (
        struct _Context * newCtx );
    HRESULT Freeze (
        struct _Context * newContext );
    ...
    //
      ...
      virtual HRESULT __stdcall get_name (
        /*[out,retval]*/ BSTR * pRetVal ) = 0;
      virtual HRESULT __stdcall raw_IsNewContextOK (
...
IRemotingFormatter : IDispatch
{
    ...
    _variant_t Deserialize (
        struct _Stream * serializationStream,
        struct _HeaderHandler * handler );
    HRESULT Serialize (
        struct _Stream * serializationStream,
        const _variant_t & graph,
        SAFEARRAY * headers );
...
ITrackingHandler : IDispatch
{
    ...
    HRESULT MarshaledObject (
        const _variant_t & obj,
        struct _ObjRef * or );
    HRESULT UnmarshaledObject (
        const _variant_t & obj,
        struct _ObjRef * or );
    HRESULT DisconnectedObject (
        const _variant_t & obj );
    ...
    //
      ...
      virtual HRESULT __stdcall raw_MarshaledObject (
        /*[in]*/ VARIANT obj,
        /*[in]*/ struct _ObjRef * or ) = 0;
      virtual HRESULT __stdcall raw_UnmarshaledObject (
        /*[in]*/ VARIANT obj,
        /*[in]*/ struct _ObjRef * or ) = 0;
      virtual HRESULT __stdcall raw_DisconnectedObject (
        /*[in]*/ VARIANT obj ) = 0;
};
...
ICspAsymmetricAlgorithm : IDispatch
{
    ...
    __declspec(property(get=GetCspKeyContainerInfo))
    _CspKeyContainerInfoPtr CspKeyContainerInfo;

    //
    // Wrapper methods for error-handling
    //

    _CspKeyContainerInfoPtr GetCspKeyContainerInfo ( );
    SAFEARRAY * ExportCspBlob (
        VARIANT_BOOL includePrivateParameters );
    HRESULT ImportCspBlob (
        SAFEARRAY * rawData );
    ...
    //
      ...
      virtual HRESULT __stdcall raw_ExportCspBlob (
        /*[in]*/ VARIANT_BOOL includePrivateParameters,
        /*[out,retval]*/ SAFEARRAY * * pRetVal ) = 0;
      virtual HRESULT __stdcall raw_ImportCspBlob (
...
IFormattable : IDispatch
{
    ...
    _bstr_t GetToString (
        _bstr_t format,
        struct IFormatProvider * formatProvider );
...
IConvertible : IDispatch
{
    ...
    enum TypeCode GetTypeCode ( );
    VARIANT_BOOL ToBoolean (
        struct IFormatProvider * provider );
    unsigned short ToChar (
        struct IFormatProvider * provider );
    char ToSByte (
        struct IFormatProvider * provider );
    ...
    //
      ...
      virtual HRESULT __stdcall raw_GetTypeCode (
        /*[out,retval]*/ enum TypeCode * pRetVal ) = 0;
      virtual HRESULT __stdcall raw_ToBoolean (
        /*[in]*/ struct IFormatProvider * provider,
        /*[out,retval]*/ VARIANT_BOOL * pRetVal ) = 0;
      virtual HRESULT __stdcall raw_ToChar (
        /*[in]*/ struct IFormatProvider * provider,
        /*[out,retval]*/ unsigned short * pRetVal ) = 0;
      virtual HRESULT __stdcall raw_ToSByte (
        /*[in]*/ struct IFormatProvider * provider,
        /*[out,retval]*/ char * pRetVal ) = 0;
      virtual HRESULT __stdcall raw_ToByte (
        /*[in]*/ struct IFormatProvider * provider,
        /*[out,retval]*/ unsigned char * pRetVal ) = 0;
      virtual HRESULT __stdcall raw_ToInt16 (
        /*[in]*/ struct IFormatProvider * provider,
        /*[out,retval]*/ short * pRetVal ) = 0;
      virtual HRESULT __stdcall raw_ToUInt16 (
        /*[in]*/ struct IFormatProvider * provider,
        /*[out,retval]*/ unsigned short * pRetVal ) = 0;
      virtual HRESULT __stdcall raw_ToInt32 (
        /*[in]*/ struct IFormatProvider * provider,
        /*[out,retval]*/ long * pRetVal ) = 0;
      virtual HRESULT __stdcall raw_ToUInt32 (
        /*[in]*/ struct IFormatProvider * provider,
        /*[out,retval]*/ unsigned long * pRetVal ) = 0;
      virtual HRESULT __stdcall raw_ToInt64 (
        /*[in]*/ struct IFormatProvider * provider,
        /*[out,retval]*/ __int64 * pRetVal ) = 0;
      virtual HRESULT __stdcall raw_ToUInt64 (
        /*[in]*/ struct IFormatProvider * provider,
        /*[out,retval]*/ unsigned __int64 * pRetVal ) = 0;
      virtual HRESULT __stdcall raw_ToSingle (
        /*[in]*/ struct IFormatProvider * provider,
        /*[out,retval]*/ float * pRetVal ) = 0;
      virtual HRESULT __stdcall raw_ToDouble (
        /*[in]*/ struct IFormatProvider * provider,
        /*[out,retval]*/ double * pRetVal ) = 0;
      virtual HRESULT __stdcall raw_ToDecimal (
        /*[in]*/ struct IFormatProvider * provider,
        /*[out,retval]*/ DECIMAL * pRetVal ) = 0;
      virtual HRESULT __stdcall raw_ToDateTime (
        /*[in]*/ struct IFormatProvider * provider,
        /*[out,retval]*/ DATE * pRetVal ) = 0;
      virtual HRESULT __stdcall get_ToString (
        /*[in]*/ struct IFormatProvider * provider,
        /*[out,retval]*/ BSTR * pRetVal ) = 0;
      virtual HRESULT __stdcall raw_ToType (
...
_Exception : IDispatch
{
    ...
    _bstr_t Message;
    __declspec(property(get=GetStackTrace))
    _bstr_t StackTrace;
    __declspec(property(get=GetHelpLink,put=PutHelpLink))
    _bstr_t HelpLink;
    __declspec(property(get=GetSource,put=PutSource))
    _bstr_t Source;
    __declspec(property(get=GetInnerException))
    _ExceptionPtr InnerException;
    __declspec(property(get=GetTargetSite))
    _MethodBasePtr TargetSite;
    ...
    _TypePtr GetType ( );
    _bstr_t GetMessage ( );
    _ExceptionPtr GetBaseException ( );
    _bstr_t GetStackTrace ( );
    _bstr_t GetHelpLink ( );
    void PutHelpLink (
        _bstr_t pRetVal );
    _bstr_t GetSource ( );
    ...
    HRESULT GetObjectData (
        struct _SerializationInfo * info,
        struct StreamingContext Context );
    _ExceptionPtr GetInnerException ( );
    _MethodBasePtr GetTargetSite ( );
    ...
    //
      ...
      virtual HRESULT __stdcall get_Message (
        /*[out,retval]*/ BSTR * pRetVal ) = 0;
      virtual HRESULT __stdcall raw_GetBaseException (
...
IClientResponseChannelSinkStack : IDispatch
{
    ...
    HRESULT AsyncProcessResponse (
        struct ITransportHeaders * headers,
        struct _Stream * Stream );
    HRESULT DispatchReplyMessage (
        struct IMessage * msg );
    HRESULT DispatchException (
        struct _Exception * e );
    ...
    //
      ...
      virtual HRESULT __stdcall raw_AsyncProcessResponse (
        /*[in]*/ struct ITransportHeaders * headers,
        /*[in]*/ struct _Stream * Stream ) = 0;
      virtual HRESULT __stdcall raw_DispatchReplyMessage (
        /*[in]*/ struct IMessage * msg ) = 0;
      virtual HRESULT __stdcall raw_DispatchException (
...
IMethodReturnMessage : IDispatch
{
    ...
    __declspec(property(get=GetOutArgCount))
    long OutArgCount;
    __declspec(property(get=GetOutArgs))
    SAFEARRAY * OutArgs;
    __declspec(property(get=GetException))
    _ExceptionPtr Exception;
    __declspec(property(get=GetReturnValue))
    ...
    long GetOutArgCount ( );
    _bstr_t GetOutArgName (
        long index );
    _variant_t GetOutArg (
        long argNum );
    SAFEARRAY * GetOutArgs ( );
    _ExceptionPtr GetException ( );
    _variant_t GetReturnValue ( );
    ...
    //
      ...
      virtual HRESULT __stdcall get_OutArgCount (
        /*[out,retval]*/ long * pRetVal ) = 0;
      virtual HRESULT __stdcall raw_GetOutArgName (
        /*[in]*/ long index,
        /*[out,retval]*/ BSTR * pRetVal ) = 0;
      virtual HRESULT __stdcall raw_GetOutArg (
        /*[in]*/ long argNum,
        /*[out,retval]*/ VARIANT * pRetVal ) = 0;
...
_AppDomain : IUnknown
{
    ...
    __declspec(property(get=GetToString))
    _bstr_t ToString;
    __declspec(property(get=GetDynamicDirectory))
    _bstr_t DynamicDirectory;
    __declspec(property(get=GetEvidence))
    _EvidencePtr Evidence;
    __declspec(property(get=GetFriendlyName))
    _bstr_t FriendlyName;
    __declspec(property(get=GetBaseDirectory))
    _bstr_t BaseDirectory;
    __declspec(property(get=GetRelativeSearchPath))
    _bstr_t RelativeSearchPath;
    __declspec(property(get=GetShadowCopyFiles))
    VARIANT_BOOL ShadowCopyFiles;
    ...
    _bstr_t GetToString ( );
    VARIANT_BOOL Equals (
        const _variant_t & other );
    long GetHashCode ( );
    _TypePtr GetType ( );
    _variant_t InitializeLifetimeService ( );
    _variant_t GetLifetimeService ( );
    _EvidencePtr GetEvidence ( );
    HRESULT add_DomainUnload (
        struct _EventHandler * value );
    HRESULT remove_DomainUnload (
        struct _EventHandler * value );
    HRESULT add_AssemblyLoad (
        struct _AssemblyLoadEventHandler * value );
    ...
    HRESULT add_TypeResolve (
        struct _ResolveEventHandler * value );
    ...
    HRESULT add_UnhandledException (
        struct _UnhandledExceptionEventHandler * value );
    HRESULT remove_UnhandledException (
        struct _UnhandledExceptionEventHandler * value );
    _AssemblyBuilderPtr DefineDynamicAssembly (
        struct _AssemblyName * name,
        enum AssemblyBuilderAccess access );
    _AssemblyBuilderPtr DefineDynamicAssembly_2 (
        struct _AssemblyName * name,
        enum AssemblyBuilderAccess access,
        _bstr_t dir );
    _AssemblyBuilderPtr DefineDynamicAssembly_3 (
        struct _AssemblyName * name,
        enum AssemblyBuilderAccess access,
        struct _Evidence * Evidence );
    _AssemblyBuilderPtr DefineDynamicAssembly_4 (
        struct _AssemblyName * name,
        enum AssemblyBuilderAccess access,
        struct _PermissionSet * requiredPermissions,
        struct _PermissionSet * optionalPermissions,
        struct _PermissionSet * refusedPermissions );
    _AssemblyBuilderPtr DefineDynamicAssembly_5 (
        struct _AssemblyName * name,
        enum AssemblyBuilderAccess access,
        _bstr_t dir,
        struct _Evidence * Evidence );
    _AssemblyBuilderPtr DefineDynamicAssembly_6 (
        struct _AssemblyName * name,
        enum AssemblyBuilderAccess access,
        _bstr_t dir,
        struct _PermissionSet * requiredPermissions,
        struct _PermissionSet * optionalPermissions,
        struct _PermissionSet * refusedPermissions );
    _AssemblyBuilderPtr DefineDynamicAssembly_7 (
        struct _AssemblyName * name,
        enum AssemblyBuilderAccess access,
        struct _Evidence * Evidence,
        struct _PermissionSet * requiredPermissions,
        struct _PermissionSet * optionalPermissions,
        struct _PermissionSet * refusedPermissions );
    _AssemblyBuilderPtr DefineDynamicAssembly_8 (
        struct _AssemblyName * name,
        enum AssemblyBuilderAccess access,
        _bstr_t dir,
        struct _Evidence * Evidence,
        ...
        struct _PermissionSet * optionalPermissions,
        struct _PermissionSet * refusedPermissions );
    _AssemblyBuilderPtr DefineDynamicAssembly_9 (
        struct _AssemblyName * name,
        enum AssemblyBuilderAccess access,
        _bstr_t dir,
        struct _Evidence * Evidence,
        ...
        struct _PermissionSet * refusedPermissions,
        VARIANT_BOOL IsSynchronized );
    _ObjectHandlePtr CreateInstance (
        _bstr_t AssemblyName,
        _bstr_t typeName );
    _ObjectHandlePtr CreateInstanceFrom (
        _bstr_t assemblyFile,
        _bstr_t typeName );
    _ObjectHandlePtr CreateInstance_2 (
        _bstr_t AssemblyName,
        _bstr_t typeName,
        SAFEARRAY * activationAttributes );
    _ObjectHandlePtr CreateInstanceFrom_2 (
        _bstr_t assemblyFile,
        _bstr_t typeName,
        SAFEARRAY * activationAttributes );
    _ObjectHandlePtr CreateInstance_3 (
        _bstr_t AssemblyName,
        _bstr_t typeName,
        VARIANT_BOOL ignoreCase,
        enum BindingFlags bindingAttr,
        struct _Binder * Binder,
        SAFEARRAY * args,
        struct _CultureInfo * culture,
        SAFEARRAY * activationAttributes,
        struct _Evidence * securityAttributes );
    _ObjectHandlePtr CreateInstanceFrom_3 (
        _bstr_t assemblyFile,
        _bstr_t typeName,
        VARIANT_BOOL ignoreCase,
        enum BindingFlags bindingAttr,
        ...
        struct _Evidence * securityAttributes );
    _AssemblyPtr Load (
        struct _AssemblyName * assemblyRef );
    _AssemblyPtr Load_2 (
        _bstr_t assemblyString );
    _AssemblyPtr Load_3 (
    ...
    _AssemblyPtr Load_5 (
        SAFEARRAY * rawAssembly,
        SAFEARRAY * rawSymbolStore,
        struct _Evidence * securityEvidence );
    _AssemblyPtr Load_6 (
        struct _AssemblyName * assemblyRef,
        struct _Evidence * assemblySecurity );
    _AssemblyPtr Load_7 (
        _bstr_t assemblyString,
        struct _Evidence * assemblySecurity );
    long ExecuteAssembly (
        _bstr_t assemblyFile,
        struct _Evidence * assemblySecurity );
    long ExecuteAssembly_2 (
        _bstr_t assemblyFile );
    long ExecuteAssembly_3 (
        _bstr_t assemblyFile,
        struct _Evidence * assemblySecurity,
        SAFEARRAY * args );
    ...
    VARIANT_BOOL GetShadowCopyFiles ( );
    SAFEARRAY * GetAssemblies ( );
    HRESULT AppendPrivatePath (
        _bstr_t Path );
    HRESULT ClearPrivatePath ( );
    HRESULT SetShadowCopyPath (
        _bstr_t s );
    HRESULT ClearShadowCopyPath ( );
    HRESULT SetCachePath (
        _bstr_t s );
    HRESULT SetData (
        _bstr_t name,
        const _variant_t & data );
    _variant_t GetData (
        _bstr_t name );
    HRESULT SetAppDomainPolicy (
        struct _PolicyLevel * domainPolicy );
    HRESULT SetThreadPrincipal (
        struct IPrincipal * principal );
    HRESULT SetPrincipalPolicy (
        enum PrincipalPolicy policy );
    HRESULT DoCallBack (
        struct _CrossAppDomainDelegate * theDelegate );
    _bstr_t GetDynamicDirectory ( );
    ...
    //
      ...
      virtual HRESULT __stdcall raw_GetType (
        /*[out,retval]*/ struct _Type * * pRetVal ) = 0;
      virtual HRESULT __stdcall raw_InitializeLifetimeService (
        /*[out,retval]*/ VARIANT * pRetVal ) = 0;
      virtual HRESULT __stdcall raw_GetLifetimeService (
        /*[out,retval]*/ VARIANT * pRetVal ) = 0;
      virtual HRESULT __stdcall get_Evidence (
        /*[out,retval]*/ struct _Evidence * * pRetVal ) = 0;
      virtual HRESULT __stdcall raw_add_DomainUnload (
        /*[in]*/ struct _EventHandler * value ) = 0;
      virtual HRESULT __stdcall raw_remove_DomainUnload (
        /*[in]*/ struct _EventHandler * value ) = 0;
      virtual HRESULT __stdcall raw_add_AssemblyLoad (
        /*[in]*/ struct _AssemblyLoadEventHandler * value ) = 0;
      virtual HRESULT __stdcall raw_remove_AssemblyLoad (
        /*[in]*/ struct _AssemblyLoadEventHandler * value ) = 0;
      virtual HRESULT __stdcall raw_add_ProcessExit (
        /*[in]*/ struct _EventHandler * value ) = 0;
      virtual HRESULT __stdcall raw_remove_ProcessExit (
        /*[in]*/ struct _EventHandler * value ) = 0;
      virtual HRESULT __stdcall raw_add_TypeResolve (
        /*[in]*/ struct _ResolveEventHandler * value ) = 0;
      virtual HRESULT __stdcall raw_remove_TypeResolve (
        /*[in]*/ struct _ResolveEventHandler * value ) = 0;
      virtual HRESULT __stdcall raw_add_ResourceResolve (
        /*[in]*/ struct _ResolveEventHandler * value ) = 0;
      virtual HRESULT __stdcall raw_remove_ResourceResolve (
        /*[in]*/ struct _ResolveEventHandler * value ) = 0;
      virtual HRESULT __stdcall raw_add_AssemblyResolve (
        /*[in]*/ struct _ResolveEventHandler * value ) = 0;
      virtual HRESULT __stdcall raw_remove_AssemblyResolve (
        /*[in]*/ struct _ResolveEventHandler * value ) = 0;
      virtual HRESULT __stdcall raw_add_UnhandledException (
        /*[in]*/ struct _UnhandledExceptionEventHandler * value ) = 0;
      virtual HRESULT __stdcall raw_remove_UnhandledException (
        /*[in]*/ struct _UnhandledExceptionEventHandler * value ) = 0;
      virtual HRESULT __stdcall raw_DefineDynamicAssembly (
        /*[in]*/ struct _AssemblyName * name,
        /*[in]*/ enum AssemblyBuilderAccess access,
        /*[out,retval]*/ struct _AssemblyBuilder * * pRetVal ) = 0;
      virtual HRESULT __stdcall raw_DefineDynamicAssembly_2 (
        /*[in]*/ struct _AssemblyName * name,
        /*[in]*/ enum AssemblyBuilderAccess access,
        /*[in]*/ BSTR dir,
        /*[out,retval]*/ struct _AssemblyBuilder * * pRetVal ) = 0;
      virtual HRESULT __stdcall raw_DefineDynamicAssembly_3 (
        /*[in]*/ struct _AssemblyName * name,
        /*[in]*/ enum AssemblyBuilderAccess access,
        /*[in]*/ struct _Evidence * Evidence,
        /*[out,retval]*/ struct _AssemblyBuilder * * pRetVal ) = 0;
      virtual HRESULT __stdcall raw_DefineDynamicAssembly_4 (
        /*[in]*/ struct _AssemblyName * name,
        /*[in]*/ enum AssemblyBuilderAccess access,
        ...
        /*[out,retval]*/ struct _AssemblyBuilder * * pRetVal ) = 0;
      virtual HRESULT __stdcall raw_DefineDynamicAssembly_5 (
        /*[in]*/ struct _AssemblyName * name,
        /*[in]*/ enum AssemblyBuilderAccess access,
        /*[in]*/ BSTR dir,
        /*[in]*/ struct _Evidence * Evidence,
        /*[out,retval]*/ struct _AssemblyBuilder * * pRetVal ) = 0;
      virtual HRESULT __stdcall raw_DefineDynamicAssembly_6 (
        /*[in]*/ struct _AssemblyName * name,
        /*[in]*/ enum AssemblyBuilderAccess access,
        /*[in]*/ BSTR dir,
        /*[in]*/ struct _PermissionSet * requiredPermissions,
        ...
        /*[in]*/ struct _PermissionSet * refusedPermissions,
        /*[out,retval]*/ struct _AssemblyBuilder * * pRetVal ) = 0;
      virtual HRESULT __stdcall raw_DefineDynamicAssembly_7 (
        /*[in]*/ struct _AssemblyName * name,
        /*[in]*/ enum AssemblyBuilderAccess access,
        /*[in]*/ struct _Evidence * Evidence,
        /*[in]*/ struct _PermissionSet * requiredPermissions,
        ...
        /*[in]*/ struct _PermissionSet * refusedPermissions,
        /*[out,retval]*/ struct _AssemblyBuilder * * pRetVal ) = 0;
      virtual HRESULT __stdcall raw_DefineDynamicAssembly_8 (
        /*[in]*/ struct _AssemblyName * name,
        /*[in]*/ enum AssemblyBuilderAccess access,
        /*[in]*/ BSTR dir,
        /*[in]*/ struct _Evidence * Evidence,
        ...
        /*[in]*/ struct _PermissionSet * refusedPermissions,
        /*[out,retval]*/ struct _AssemblyBuilder * * pRetVal ) = 0;
      virtual HRESULT __stdcall raw_DefineDynamicAssembly_9 (
        /*[in]*/ struct _AssemblyName * name,
        /*[in]*/ enum AssemblyBuilderAccess access,
        /*[in]*/ BSTR dir,
        /*[in]*/ struct _Evidence * Evidence,
      ...
      virtual HRESULT __stdcall raw_CreateInstanceFrom (
        /*[in]*/ BSTR assemblyFile,
        /*[in]*/ BSTR typeName,
        /*[out,retval]*/ struct _ObjectHandle * * pRetVal ) = 0;
      virtual HRESULT __stdcall raw_CreateInstance_2 (
        /*[in]*/ BSTR AssemblyName,
        /*[in]*/ BSTR typeName,
        /*[in]*/ SAFEARRAY * activationAttributes,
        /*[out,retval]*/ struct _ObjectHandle * * pRetVal ) = 0;
      virtual HRESULT __stdcall raw_CreateInstanceFrom_2 (
        /*[in]*/ BSTR assemblyFile,
        /*[in]*/ BSTR typeName,
        /*[in]*/ SAFEARRAY * activationAttributes,
        /*[out,retval]*/ struct _ObjectHandle * * pRetVal ) = 0;
      virtual HRESULT __stdcall raw_CreateInstance_3 (
        /*[in]*/ BSTR AssemblyName,
        /*[in]*/ BSTR typeName,
        ...
        /*[out,retval]*/ struct _ObjectHandle * * pRetVal ) = 0;
      virtual HRESULT __stdcall raw_CreateInstanceFrom_3 (
        /*[in]*/ BSTR assemblyFile,
        /*[in]*/ BSTR typeName,
        /*[in]*/ VARIANT_BOOL ignoreCase,
        /*[in]*/ enum BindingFlags bindingAttr,
      ...
      virtual HRESULT __stdcall raw_Load_2 (
        /*[in]*/ BSTR assemblyString,
        /*[out,retval]*/ struct _Assembly * * pRetVal ) = 0;
      virtual HRESULT __stdcall raw_Load_3 (
        /*[in]*/ SAFEARRAY * rawAssembly,
        /*[out,retval]*/ struct _Assembly * * pRetVal ) = 0;
      virtual HRESULT __stdcall raw_Load_4 (
        /*[in]*/ SAFEARRAY * rawAssembly,
        /*[in]*/ SAFEARRAY * rawSymbolStore,
        /*[out,retval]*/ struct _Assembly * * pRetVal ) = 0;
      virtual HRESULT __stdcall raw_Load_5 (
        /*[in]*/ SAFEARRAY * rawAssembly,
        /*[in]*/ SAFEARRAY * rawSymbolStore,
        /*[in]*/ struct _Evidence * securityEvidence,
        /*[out,retval]*/ struct _Assembly * * pRetVal ) = 0;
      virtual HRESULT __stdcall raw_Load_6 (
        /*[in]*/ struct _AssemblyName * assemblyRef,
        /*[in]*/ struct _Evidence * assemblySecurity,
        /*[out,retval]*/ struct _Assembly * * pRetVal ) = 0;
      virtual HRESULT __stdcall raw_Load_7 (
        /*[in]*/ BSTR assemblyString,
        /*[in]*/ struct _Evidence * assemblySecurity,
        /*[out,retval]*/ struct _Assembly * * pRetVal ) = 0;
      virtual HRESULT __stdcall raw_ExecuteAssembly (
        /*[in]*/ BSTR assemblyFile,
        /*[in]*/ struct _Evidence * assemblySecurity,
        /*[out,retval]*/ long * pRetVal ) = 0;
      virtual HRESULT __stdcall raw_ExecuteAssembly_2 (
        /*[in]*/ BSTR assemblyFile,
        /*[out,retval]*/ long * pRetVal ) = 0;
      virtual HRESULT __stdcall raw_ExecuteAssembly_3 (
        /*[in]*/ BSTR assemblyFile,
        /*[in]*/ struct _Evidence * assemblySecurity,
        /*[in]*/ SAFEARRAY * args,
        /*[out,retval]*/ long * pRetVal ) = 0;
      ...
      virtual HRESULT __stdcall get_ShadowCopyFiles (
        /*[out,retval]*/ VARIANT_BOOL * pRetVal ) = 0;
      virtual HRESULT __stdcall raw_GetAssemblies (
        /*[out,retval]*/ SAFEARRAY * * pRetVal ) = 0;
      virtual HRESULT __stdcall raw_AppendPrivatePath (
        /*[in]*/ BSTR Path ) = 0;
      virtual HRESULT __stdcall raw_ClearPrivatePath ( ) = 0;
      virtual HRESULT __stdcall raw_SetShadowCopyPath (
        /*[in]*/ BSTR s ) = 0;
      virtual HRESULT __stdcall raw_ClearShadowCopyPath ( ) = 0;
      virtual HRESULT __stdcall raw_SetCachePath (
        /*[in]*/ BSTR s ) = 0;
      ...
      virtual HRESULT __stdcall raw_GetData (
        /*[in]*/ BSTR name,
        /*[out,retval]*/ VARIANT * pRetVal ) = 0;
      virtual HRESULT __stdcall raw_SetAppDomainPolicy (
        /*[in]*/ struct _PolicyLevel * domainPolicy ) = 0;
      virtual HRESULT __stdcall raw_SetThreadPrincipal (
        /*[in]*/ struct IPrincipal * principal ) = 0;
      virtual HRESULT __stdcall raw_SetPrincipalPolicy (
        /*[in]*/ enum PrincipalPolicy policy ) = 0;
      virtual HRESULT __stdcall raw_DoCallBack (
...
ICustomAttributeProvider : IDispatch
{
    ...
    //
      ...
      virtual HRESULT __stdcall raw_GetCustomAttributes (
        /*[in]*/ struct _Type * attributeType,
        /*[in]*/ VARIANT_BOOL inherit,
        /*[out,retval]*/ SAFEARRAY * * pRetVal ) = 0;
      virtual HRESULT __stdcall raw_GetCustomAttributes_2 (
        /*[in]*/ VARIANT_BOOL inherit,
        /*[out,retval]*/ SAFEARRAY * * pRetVal ) = 0;
      virtual HRESULT __stdcall raw_IsDefined (
        /*[in]*/ struct _Type * attributeType,
        /*[in]*/ VARIANT_BOOL inherit,
        /*[out,retval]*/ VARIANT_BOOL * pRetVal ) = 0;
};
...
_MemberInfo : IUnknown
{
    ...
    enum MemberTypes MemberType;
    __declspec(property(get=Getname))
    _bstr_t name;
    __declspec(property(get=GetDeclaringType))
    _TypePtr DeclaringType;
    __declspec(property(get=GetReflectedType))
    _TypePtr ReflectedType;
    ...
    long GetHashCode ( );
    _TypePtr GetType ( );
    enum MemberTypes GetMemberType ( );
    _bstr_t Getname ( );
    _TypePtr GetDeclaringType ( );
    _TypePtr GetReflectedType ( );
    SAFEARRAY * GetCustomAttributes (
        struct _Type * attributeType,
        VARIANT_BOOL inherit );
    SAFEARRAY * GetCustomAttributes_2 (
...
_Type : IUnknown
{
    ...
    __declspec(property(get=GetToString))
    _bstr_t ToString;
    __declspec(property(get=GetIsNestedPublic))
    VARIANT_BOOL IsNestedPublic;
    __declspec(property(get=GetIsNestedPrivate))
    VARIANT_BOOL IsNestedPrivate;
    __declspec(property(get=GetIsNestedFamily))
    VARIANT_BOOL IsNestedFamily;
    __declspec(property(get=GetIsNestedAssembly))
    VARIANT_BOOL IsNestedAssembly;
    __declspec(property(get=GetIsNestedFamANDAssem))
    VARIANT_BOOL IsNestedFamANDAssem;
    __declspec(property(get=GetIsAutoLayout))
    VARIANT_BOOL IsAutoLayout;
    __declspec(property(get=GetIsLayoutSequential))
    VARIANT_BOOL IsLayoutSequential;
    __declspec(property(get=GetMemberType))
    enum MemberTypes MemberType;
    __declspec(property(get=Getname))
    _bstr_t name;
    ...
    __declspec(property(get=GetReflectedType))
    _TypePtr ReflectedType;
    __declspec(property(get=GetIsExplicitLayout))
    VARIANT_BOOL IsExplicitLayout;
    __declspec(property(get=GetIsClass))
    VARIANT_BOOL IsClass;
    __declspec(property(get=GetIsInterface))
    VARIANT_BOOL IsInterface;
    __declspec(property(get=GetGuid))
    GUID Guid;
    __declspec(property(get=GetModule))
    _ModulePtr Module;
    __declspec(property(get=GetAssembly))
    _AssemblyPtr Assembly;
    __declspec(property(get=GetTypeHandle))
    struct RuntimeTypeHandle TypeHandle;
    __declspec(property(get=GetFullName))
    _bstr_t FullName;
    __declspec(property(get=GetNamespace))
    _bstr_t Namespace;
    __declspec(property(get=GetAssemblyQualifiedName))
    _bstr_t AssemblyQualifiedName;
    __declspec(property(get=GetIsValueType))
    VARIANT_BOOL IsValueType;
    __declspec(property(get=GetBaseType))
    _TypePtr BaseType;
    __declspec(property(get=GetIsNestedFamORAssem))
    VARIANT_BOOL IsNestedFamORAssem;
    __declspec(property(get=GetIsAbstract))
    VARIANT_BOOL IsAbstract;
    __declspec(property(get=GetIsSealed))
    VARIANT_BOOL IsSealed;
    __declspec(property(get=GetIsEnum))
    VARIANT_BOOL IsEnum;
    __declspec(property(get=GetIsSpecialName))
    VARIANT_BOOL IsSpecialName;
    __declspec(property(get=GetIsImport))
    VARIANT_BOOL IsImport;
    __declspec(property(get=GetIsSerializable))
    VARIANT_BOOL IsSerializable;
    __declspec(property(get=GetIsAnsiClass))
    VARIANT_BOOL IsAnsiClass;
    __declspec(property(get=GetIsUnicodeClass))
    VARIANT_BOOL IsUnicodeClass;
    __declspec(property(get=GetIsAutoClass))
    VARIANT_BOOL IsAutoClass;
    __declspec(property(get=GetIsArray))
    VARIANT_BOOL IsArray;
    __declspec(property(get=GetIsByRef))
    VARIANT_BOOL IsByRef;
    __declspec(property(get=GetIsPointer))
    VARIANT_BOOL IsPointer;
    __declspec(property(get=GetIsPrimitive))
    VARIANT_BOOL IsPrimitive;
    __declspec(property(get=GetIsCOMObject))
    VARIANT_BOOL IsCOMObject;
    __declspec(property(get=GetHasElementType))
    VARIANT_BOOL HasElementType;
    __declspec(property(get=GetIsContextful))
    VARIANT_BOOL IsContextful;
    __declspec(property(get=GetIsMarshalByRef))
    VARIANT_BOOL IsMarshalByRef;
    __declspec(property(get=GetUnderlyingSystemType))
    _TypePtr UnderlyingSystemType;
    __declspec(property(get=GetTypeInitializer))
    _ConstructorInfoPtr TypeInitializer;
    __declspec(property(get=GetAttributes))
    enum TypeAttributes Attributes;
    __declspec(property(get=GetIsNotPublic))
    VARIANT_BOOL IsNotPublic;
    ...
    VARIANT_BOOL IsDefined (
        ...
        VARIANT_BOOL inherit );
    GUID GetGuid ( );
    _ModulePtr GetModule ( );
    _AssemblyPtr GetAssembly ( );
    struct RuntimeTypeHandle GetTypeHandle ( );
    _bstr_t GetFullName ( );
    _bstr_t GetNamespace ( );
    _bstr_t GetAssemblyQualifiedName ( );
    long GetArrayRank ( );
    _TypePtr GetBaseType ( );
    SAFEARRAY * GetConstructors (
        enum BindingFlags bindingAttr );
    _TypePtr GetInterface (
        _bstr_t name,
        VARIANT_BOOL ignoreCase );
    SAFEARRAY * GetInterfaces ( );
    SAFEARRAY * FindInterfaces (
        struct _TypeFilter * filter,
        const _variant_t & filterCriteria );
    _EventInfoPtr GetEvent (
        _bstr_t name,
        enum BindingFlags bindingAttr );
    SAFEARRAY * GetEvents ( );
    ...
    SAFEARRAY * FindMembers (
        enum MemberTypes MemberType,
        enum BindingFlags bindingAttr,
        struct _MemberFilter * filter,
        const _variant_t & filterCriteria );
    _TypePtr GetElementType ( );
    VARIANT_BOOL IsSubclassOf (
        struct _Type * c );
    VARIANT_BOOL IsInstanceOfType (
        const _variant_t & o );
    VARIANT_BOOL IsAssignableFrom (
        struct _Type * c );
    struct InterfaceMapping GetInterfaceMap (
        struct _Type * interfaceType );
    _MethodInfoPtr GetMethod (
        _bstr_t name,
        enum BindingFlags bindingAttr,
        struct _Binder * Binder,
        SAFEARRAY * types,
        SAFEARRAY * modifiers );
    _MethodInfoPtr GetMethod_2 (
        _bstr_t name,
        enum BindingFlags bindingAttr );
    SAFEARRAY * GetMethods (
        enum BindingFlags bindingAttr );
    _FieldInfoPtr GetField (
        _bstr_t name,
        enum BindingFlags bindingAttr );
    SAFEARRAY * GetFields (
        enum BindingFlags bindingAttr );
    _PropertyInfoPtr GetProperty (
        _bstr_t name,
        enum BindingFlags bindingAttr );
    _PropertyInfoPtr GetProperty_2 (
        _bstr_t name,
        enum BindingFlags bindingAttr,
        struct _Binder * Binder,
    ...
    SAFEARRAY * GetMembers (
        enum BindingFlags bindingAttr );
    _variant_t InvokeMember (
        _bstr_t name,
        enum BindingFlags invokeAttr,
        struct _Binder * Binder,
    ...
    _TypePtr GetUnderlyingSystemType ( );
    _variant_t InvokeMember_2 (
        _bstr_t name,
        enum BindingFlags invokeAttr,
        struct _Binder * Binder,
        const _variant_t & Target,
        SAFEARRAY * args,
        struct _CultureInfo * culture );
    _variant_t InvokeMember_3 (
        _bstr_t name,
        enum BindingFlags invokeAttr,
        struct _Binder * Binder,
        const _variant_t & Target,
        SAFEARRAY * args );
    _ConstructorInfoPtr GetConstructor (
        enum BindingFlags bindingAttr,
        struct _Binder * Binder,
        enum CallingConventions callConvention,
        SAFEARRAY * types,
        SAFEARRAY * modifiers );
    _ConstructorInfoPtr GetConstructor_2 (
        enum BindingFlags bindingAttr,
        struct _Binder * Binder,
        SAFEARRAY * types,
        SAFEARRAY * modifiers );
    _ConstructorInfoPtr GetConstructor_3 (
        SAFEARRAY * types );
    SAFEARRAY * GetConstructors_2 ( );
    _ConstructorInfoPtr GetTypeInitializer ( );
    _MethodInfoPtr GetMethod_3 (
        _bstr_t name,
        enum BindingFlags bindingAttr,
        struct _Binder * Binder,
        enum CallingConventions callConvention,
        SAFEARRAY * types,
        SAFEARRAY * modifiers );
    _MethodInfoPtr GetMethod_4 (
        _bstr_t name,
        SAFEARRAY * types,
        SAFEARRAY * modifiers );
    _MethodInfoPtr GetMethod_5 (
        _bstr_t name,
        SAFEARRAY * types );
    _MethodInfoPtr GetMethod_6 (
        _bstr_t name );
    SAFEARRAY * GetMethods_2 ( );
    _FieldInfoPtr GetField_2 (
        _bstr_t name );
    SAFEARRAY * GetFields_2 ( );
    _TypePtr GetInterface_2 (
        _bstr_t name );
    _EventInfoPtr GetEvent_2 (
        _bstr_t name );
    _PropertyInfoPtr GetProperty_3 (
        _bstr_t name,
        struct _Type * returnType,
        SAFEARRAY * types,
        SAFEARRAY * modifiers );
    _PropertyInfoPtr GetProperty_4 (
        _bstr_t name,
        struct _Type * returnType,
        SAFEARRAY * types );
    _PropertyInfoPtr GetProperty_5 (
        _bstr_t name,
        SAFEARRAY * types );
    _PropertyInfoPtr GetProperty_6 (
        _bstr_t name,
        struct _Type * returnType );
    _PropertyInfoPtr GetProperty_7 (
        _bstr_t name );
    SAFEARRAY * GetProperties_2 ( );
    SAFEARRAY * GetNestedTypes_2 ( );
    _TypePtr GetNestedType_2 (
        _bstr_t name );
    SAFEARRAY * GetMember_3 (
        _bstr_t name );
    SAFEARRAY * GetMembers_2 ( );
    enum TypeAttributes GetAttributes ( );
    VARIANT_BOOL GetIsNotPublic ( );
    VARIANT_BOOL GetIsPublic ( );
    VARIANT_BOOL GetIsNestedPublic ( );
    VARIANT_BOOL GetIsNestedPrivate ( );
    VARIANT_BOOL GetIsNestedFamily ( );
    VARIANT_BOOL GetIsNestedAssembly ( );
    VARIANT_BOOL GetIsNestedFamANDAssem ( );
    VARIANT_BOOL GetIsNestedFamORAssem ( );
    VARIANT_BOOL GetIsAutoLayout ( );
    VARIANT_BOOL GetIsLayoutSequential ( );
    VARIANT_BOOL GetIsExplicitLayout ( );
    VARIANT_BOOL GetIsClass ( );
    VARIANT_BOOL GetIsInterface ( );
    VARIANT_BOOL GetIsValueType ( );
    VARIANT_BOOL GetIsAbstract ( );
    VARIANT_BOOL GetIsSealed ( );
    VARIANT_BOOL GetIsEnum ( );
    VARIANT_BOOL GetIsSpecialName ( );
    VARIANT_BOOL GetIsImport ( );
    VARIANT_BOOL GetIsSerializable ( );
    VARIANT_BOOL GetIsAnsiClass ( );
    VARIANT_BOOL GetIsUnicodeClass ( );
    VARIANT_BOOL GetIsAutoClass ( );
    VARIANT_BOOL GetIsArray ( );
    VARIANT_BOOL GetIsByRef ( );
    VARIANT_BOOL GetIsPointer ( );
    VARIANT_BOOL GetIsPrimitive ( );
    VARIANT_BOOL GetIsCOMObject ( );
    VARIANT_BOOL GetHasElementType ( );
    VARIANT_BOOL GetIsContextful ( );
    VARIANT_BOOL GetIsMarshalByRef ( );
    VARIANT_BOOL Equals_2 (
        struct _Type * o );
    ...
    //
      ...
      virtual HRESULT __stdcall get_AssemblyQualifiedName (
        /*[out,retval]*/ BSTR * pRetVal ) = 0;
      virtual HRESULT __stdcall raw_GetArrayRank (
        /*[out,retval]*/ long * pRetVal ) = 0;
      virtual HRESULT __stdcall get_BaseType (
        /*[out,retval]*/ struct _Type * * pRetVal ) = 0;
      virtual HRESULT __stdcall raw_GetConstructors (
        /*[in]*/ enum BindingFlags bindingAttr,
        /*[out,retval]*/ SAFEARRAY * * pRetVal ) = 0;
      virtual HRESULT __stdcall raw_GetInterface (
        ...
        /*[in]*/ VARIANT_BOOL ignoreCase,
        /*[out,retval]*/ struct _Type * * pRetVal ) = 0;
      virtual HRESULT __stdcall raw_GetInterfaces (
        /*[out,retval]*/ SAFEARRAY * * pRetVal ) = 0;
      virtual HRESULT __stdcall raw_FindInterfaces (
      ...
      virtual HRESULT __stdcall raw_GetEvents (
        /*[out,retval]*/ SAFEARRAY * * pRetVal ) = 0;
      virtual HRESULT __stdcall raw_GetEvents_2 (
        /*[in]*/ enum BindingFlags bindingAttr,
        /*[out,retval]*/ SAFEARRAY * * pRetVal ) = 0;
      virtual HRESULT __stdcall raw_GetNestedTypes (
        /*[in]*/ enum BindingFlags bindingAttr,
        /*[out,retval]*/ SAFEARRAY * * pRetVal ) = 0;
      virtual HRESULT __stdcall raw_GetNestedType (
        /*[in]*/ BSTR name,
        /*[in]*/ enum BindingFlags bindingAttr,
        /*[out,retval]*/ struct _Type * * pRetVal ) = 0;
      virtual HRESULT __stdcall raw_GetMember (
        ...
        /*[in]*/ enum BindingFlags bindingAttr,
        /*[out,retval]*/ SAFEARRAY * * pRetVal ) = 0;
      virtual HRESULT __stdcall raw_GetDefaultMembers (
        /*[out,retval]*/ SAFEARRAY * * pRetVal ) = 0;
      virtual HRESULT __stdcall raw_FindMembers (
      ...
      virtual HRESULT __stdcall raw_GetElementType (
        /*[out,retval]*/ struct _Type * * pRetVal ) = 0;
      virtual HRESULT __stdcall raw_IsSubclassOf (
        /*[in]*/ struct _Type * c,
        /*[out,retval]*/ VARIANT_BOOL * pRetVal ) = 0;
      virtual HRESULT __stdcall raw_IsInstanceOfType (
        /*[in]*/ VARIANT o,
        /*[out,retval]*/ VARIANT_BOOL * pRetVal ) = 0;
      virtual HRESULT __stdcall raw_IsAssignableFrom (
        /*[in]*/ struct _Type * c,
        /*[out,retval]*/ VARIANT_BOOL * pRetVal ) = 0;
      virtual HRESULT __stdcall raw_GetInterfaceMap (
      ...
      virtual HRESULT __stdcall raw_GetMethod_2 (
        /*[in]*/ BSTR name,
        /*[in]*/ enum BindingFlags bindingAttr,
        /*[out,retval]*/ struct _MethodInfo * * pRetVal ) = 0;
      virtual HRESULT __stdcall raw_GetMethods (
        /*[in]*/ enum BindingFlags bindingAttr,
        /*[out,retval]*/ SAFEARRAY * * pRetVal ) = 0;
      ...
      virtual HRESULT __stdcall raw_GetProperty_2 (
        /*[in]*/ BSTR name,
        /*[in]*/ enum BindingFlags bindingAttr,
        /*[in]*/ struct _Binder * Binder,
      ...
      virtual HRESULT __stdcall raw_GetProperties (
        /*[in]*/ enum BindingFlags bindingAttr,
        /*[out,retval]*/ SAFEARRAY * * pRetVal ) = 0;
      virtual HRESULT __stdcall raw_GetMember_2 (
        /*[in]*/ BSTR name,
        /*[in]*/ enum BindingFlags bindingAttr,
        /*[out,retval]*/ SAFEARRAY * * pRetVal ) = 0;
      virtual HRESULT __stdcall raw_GetMembers (
        /*[in]*/ enum BindingFlags bindingAttr,
        /*[out,retval]*/ SAFEARRAY * * pRetVal ) = 0;
      virtual HRESULT __stdcall raw_InvokeMember (
        /*[in]*/ BSTR name,
      ...
      virtual HRESULT __stdcall get_UnderlyingSystemType (
        /*[out,retval]*/ struct _Type * * pRetVal ) = 0;
      virtual HRESULT __stdcall raw_InvokeMember_2 (
        /*[in]*/ BSTR name,
        /*[in]*/ enum BindingFlags invokeAttr,
        /*[in]*/ struct _Binder * Binder,
        /*[in]*/ VARIANT Target,
        ...
        /*[in]*/ struct _CultureInfo * culture,
        /*[out,retval]*/ VARIANT * pRetVal ) = 0;
      virtual HRESULT __stdcall raw_InvokeMember_3 (
        /*[in]*/ BSTR name,
        /*[in]*/ enum BindingFlags invokeAttr,
        /*[in]*/ struct _Binder * Binder,
        /*[in]*/ VARIANT Target,
        /*[in]*/ SAFEARRAY * args,
        /*[out,retval]*/ VARIANT * pRetVal ) = 0;
      virtual HRESULT __stdcall raw_GetConstructor (
        /*[in]*/ enum BindingFlags bindingAttr,
        /*[in]*/ struct _Binder * Binder,
      ...
      virtual HRESULT __stdcall raw_GetConstructor_2 (
        /*[in]*/ enum BindingFlags bindingAttr,
        /*[in]*/ struct _Binder * Binder,
        /*[in]*/ SAFEARRAY * types,
        /*[in]*/ SAFEARRAY * modifiers,
        /*[out,retval]*/ struct _ConstructorInfo * * pRetVal ) = 0;
      virtual HRESULT __stdcall raw_GetConstructor_3 (
        /*[in]*/ SAFEARRAY * types,
        /*[out,retval]*/ struct _ConstructorInfo * * pRetVal ) = 0;
      virtual HRESULT __stdcall raw_GetConstructors_2 (
        /*[out,retval]*/ SAFEARRAY * * pRetVal ) = 0;
      virtual HRESULT __stdcall get_TypeInitializer (
        /*[out,retval]*/ struct _ConstructorInfo * * pRetVal ) = 0;
      virtual HRESULT __stdcall raw_GetMethod_3 (
        /*[in]*/ BSTR name,
        /*[in]*/ enum BindingFlags bindingAttr,
        /*[in]*/ struct _Binder * Binder,
        /*[in]*/ enum CallingConventions callConvention,
        ...
        /*[in]*/ SAFEARRAY * modifiers,
        /*[out,retval]*/ struct _MethodInfo * * pRetVal ) = 0;
      virtual HRESULT __stdcall raw_GetMethod_4 (
        /*[in]*/ BSTR name,
        /*[in]*/ SAFEARRAY * types,
        /*[in]*/ SAFEARRAY * modifiers,
        /*[out,retval]*/ struct _MethodInfo * * pRetVal ) = 0;
      virtual HRESULT __stdcall raw_GetMethod_5 (
        /*[in]*/ BSTR name,
        /*[in]*/ SAFEARRAY * types,
        /*[out,retval]*/ struct _MethodInfo * * pRetVal ) = 0;
      virtual HRESULT __stdcall raw_GetMethod_6 (
        /*[in]*/ BSTR name,
        /*[out,retval]*/ struct _MethodInfo * * pRetVal ) = 0;
      virtual HRESULT __stdcall raw_GetMethods_2 (
        /*[out,retval]*/ SAFEARRAY * * pRetVal ) = 0;
      virtual HRESULT __stdcall raw_GetField_2 (
        /*[in]*/ BSTR name,
        /*[out,retval]*/ struct _FieldInfo * * pRetVal ) = 0;
      virtual HRESULT __stdcall raw_GetFields_2 (
        /*[out,retval]*/ SAFEARRAY * * pRetVal ) = 0;
      virtual HRESULT __stdcall raw_GetInterface_2 (
        /*[in]*/ BSTR name,
        /*[out,retval]*/ struct _Type * * pRetVal ) = 0;
      virtual HRESULT __stdcall raw_GetEvent_2 (
        /*[in]*/ BSTR name,
        /*[out,retval]*/ struct _EventInfo * * pRetVal ) = 0;
      virtual HRESULT __stdcall raw_GetProperty_3 (
        /*[in]*/ BSTR name,
        /*[in]*/ struct _Type * returnType,
        /*[in]*/ SAFEARRAY * types,
        /*[in]*/ SAFEARRAY * modifiers,
        /*[out,retval]*/ struct _PropertyInfo * * pRetVal ) = 0;
      virtual HRESULT __stdcall raw_GetProperty_4 (
        /*[in]*/ BSTR name,
        /*[in]*/ struct _Type * returnType,
        /*[in]*/ SAFEARRAY * types,
        /*[out,retval]*/ struct _PropertyInfo * * pRetVal ) = 0;
      virtual HRESULT __stdcall raw_GetProperty_5 (
        /*[in]*/ BSTR name,
        /*[in]*/ SAFEARRAY * types,
        /*[out,retval]*/ struct _PropertyInfo * * pRetVal ) = 0;
      virtual HRESULT __stdcall raw_GetProperty_6 (
        /*[in]*/ BSTR name,
        /*[in]*/ struct _Type * returnType,
        /*[out,retval]*/ struct _PropertyInfo * * pRetVal ) = 0;
      virtual HRESULT __stdcall raw_GetProperty_7 (
        /*[in]*/ BSTR name,
        /*[out,retval]*/ struct _PropertyInfo * * pRetVal ) = 0;
      virtual HRESULT __stdcall raw_GetProperties_2 (
        /*[out,retval]*/ SAFEARRAY * * pRetVal ) = 0;
      virtual HRESULT __stdcall raw_GetNestedTypes_2 (
        /*[out,retval]*/ SAFEARRAY * * pRetVal ) = 0;
      virtual HRESULT __stdcall raw_GetNestedType_2 (
        /*[in]*/ BSTR name,
        /*[out,retval]*/ struct _Type * * pRetVal ) = 0;
      virtual HRESULT __stdcall raw_GetMember_3 (
        /*[in]*/ BSTR name,
        /*[out,retval]*/ SAFEARRAY * * pRetVal ) = 0;
      virtual HRESULT __stdcall raw_GetMembers_2 (
        /*[out,retval]*/ SAFEARRAY * * pRetVal ) = 0;
      virtual HRESULT __stdcall get_Attributes (
      ...
      virtual HRESULT __stdcall get_IsMarshalByRef (
        /*[out,retval]*/ VARIANT_BOOL * pRetVal ) = 0;
      virtual HRESULT __stdcall raw_Equals_2 (
        /*[in]*/ struct _Type * o,
        /*[out,retval]*/ VARIANT_BOOL * pRetVal ) = 0;
};
...
IFormatterConverter : IDispatch
{
    ...
    //
      ...
      virtual HRESULT __stdcall raw_Convert (
        ...
        /*[out,retval]*/ VARIANT * pRetVal ) = 0;
      virtual HRESULT __stdcall raw_Convert_2 (
        /*[in]*/ VARIANT value,
...
ICustomFactory : IDispatch
{
    ...
    _MarshalByRefObjectPtr CreateInstance (
        struct _Type * serverType );
...
IRemotingTypeInfo : IDispatch
{
    ...
    void PuttypeName (
        _bstr_t pRetVal );
    VARIANT_BOOL CanCastTo (
        struct _Type * fromType,
        const _variant_t & o );
    ...
    //
      ...
      virtual HRESULT __stdcall put_typeName (
        /*[in]*/ BSTR pRetVal ) = 0;
      virtual HRESULT __stdcall raw_CanCastTo (
...
_ObjectHandle : IDispatch
{
    ...
    _variant_t GetLifetimeService ( );
    _variant_t InitializeLifetimeService ( );
    _ObjRefPtr CreateObjRef (
        struct _Type * requestedType );
    _variant_t Unwrap ( );
    ...
    //
      ...
      virtual HRESULT __stdcall raw_InitializeLifetimeService (
        /*[out,retval]*/ VARIANT * pRetVal ) = 0;
      virtual HRESULT __stdcall raw_CreateObjRef (
...
ISymbolBinder : IDispatch
{
    ...
    //
      ...
      virtual HRESULT __stdcall raw_GetReader (
        /*[in]*/ long importer,
        /*[in]*/ BSTR filename,
        /*[in]*/ BSTR searchPath,
...
ISymbolMethod : IDispatch
{
    ...
    __declspec(property(get=GetSequencePointCount))
    long SequencePointCount;
    __declspec(property(get=GetRootScope))
    ISymbolScopePtr RootScope;

    //
    // Wrapper methods for error-handling
    //

    struct SymbolToken GetToken ( );
    long GetSequencePointCount ( );
    HRESULT GetSequencePoints (
        ...
        SAFEARRAY * endLines,
        SAFEARRAY * endColumns );
    ISymbolScopePtr GetRootScope ( );
    ISymbolScopePtr GetScope (
        long offset );
    long GetOffset (
        struct ISymbolDocument * document,
        long line,
        long column );
    SAFEARRAY * GetRanges (
        struct ISymbolDocument * document,
    ...
    ISymbolNamespacePtr GetNamespace ( );
    VARIANT_BOOL GetSourceStartEnd (
        SAFEARRAY * docs,
        SAFEARRAY * lines,
        SAFEARRAY * columns );
    ...
    //
      ...
      virtual HRESULT __stdcall get_SequencePointCount (
        /*[out,retval]*/ long * pRetVal ) = 0;
      virtual HRESULT __stdcall raw_GetSequencePoints (
        /*[in]*/ SAFEARRAY * offsets,
      ...
      virtual HRESULT __stdcall raw_GetScope (
        /*[in]*/ long offset,
        /*[out,retval]*/ struct ISymbolScope * * pRetVal ) = 0;
      ...
      virtual HRESULT __stdcall raw_GetSourceStartEnd (
        /*[in]*/ SAFEARRAY * docs,
        /*[in]*/ SAFEARRAY * lines,
        /*[in]*/ SAFEARRAY * columns,
        /*[out,retval]*/ VARIANT_BOOL * pRetVal ) = 0;
...
ISymbolReader : IDispatch
{
    ...
    __declspec(property(get=GetUserEntryPoint))
    struct SymbolToken UserEntryPoint;

    //
    // Wrapper methods for error-handling
    //

    ISymbolDocumentPtr GetDocument (
        _bstr_t Url,
        GUID Language,
        GUID LanguageVendor,
        GUID DocumentType );
    SAFEARRAY * GetDocuments ( );
    struct SymbolToken GetUserEntryPoint ( );
    ISymbolMethodPtr GetMethod (
        struct SymbolToken Method );
    ISymbolMethodPtr GetMethod_2 (
        struct SymbolToken Method,
        long Version );
    SAFEARRAY * GetVariables (
        struct SymbolToken parent );
    SAFEARRAY * GetGlobalVariables ( );
    ISymbolMethodPtr GetMethodFromDocumentPosition (
        struct ISymbolDocument * document,
        long line,
        long column );
    SAFEARRAY * GetSymAttribute (
        struct SymbolToken parent,
        _bstr_t name );
    SAFEARRAY * GetNamespaces ( );
    ...
    //
      ...
      virtual HRESULT __stdcall raw_GetDocument (
        /*[in]*/ BSTR Url,
        /*[in]*/ GUID Language,
        /*[in]*/ GUID LanguageVendor,
        /*[in]*/ GUID DocumentType,
      ...
      virtual HRESULT __stdcall raw_GetVariables (
        /*[in]*/ struct SymbolToken parent,
        /*[out,retval]*/ SAFEARRAY * * pRetVal ) = 0;
      virtual HRESULT __stdcall raw_GetGlobalVariables (
        /*[out,retval]*/ SAFEARRAY * * pRetVal ) = 0;
      virtual HRESULT __stdcall raw_GetMethodFromDocumentPosition (
        /*[in]*/ struct ISymbolDocument * document,
        /*[in]*/ long line,
        /*[in]*/ long column,
        /*[out,retval]*/ struct ISymbolMethod * * pRetVal ) = 0;
      virtual HRESULT __stdcall raw_GetSymAttribute (
        /*[in]*/ struct SymbolToken parent,
        /*[in]*/ BSTR name,
        /*[out,retval]*/ SAFEARRAY * * pRetVal ) = 0;
      virtual HRESULT __stdcall raw_GetNamespaces (
...
ISymbolScope : IDispatch
{
    ...
    ISymbolMethodPtr Method;
    __declspec(property(get=Getparent))
    ISymbolScopePtr parent;
    __declspec(property(get=GetStartOffset))
    long StartOffset;
    __declspec(property(get=GetEndOffset))
    long EndOffset;
    ...
    ISymbolMethodPtr GetMethod ( );
    ISymbolScopePtr Getparent ( );
    SAFEARRAY * GetChildren ( );
    long GetStartOffset ( );
    long GetEndOffset ( );
    SAFEARRAY * GetLocals ( );
    SAFEARRAY * GetNamespaces ( );
    ...
    //
      ...
      virtual HRESULT __stdcall get_EndOffset (
        /*[out,retval]*/ long * pRetVal ) = 0;
      virtual HRESULT __stdcall raw_GetLocals (
        /*[out,retval]*/ SAFEARRAY * * pRetVal ) = 0;
      virtual HRESULT __stdcall raw_GetNamespaces (
        /*[out,retval]*/ SAFEARRAY * * pRetVal ) = 0;
};
...
_Assembly : IDispatch
{
    ...
    __declspec(property(get=GetToString))
    _bstr_t ToString;
    __declspec(property(get=GetCodeBase))
    _bstr_t CodeBase;
    __declspec(property(get=GetEscapedCodeBase))
    _bstr_t EscapedCodeBase;
    __declspec(property(get=GetFullName))
    _bstr_t FullName;
    __declspec(property(get=GetEntryPoint))
    _MethodInfoPtr EntryPoint;
    __declspec(property(get=GetGlobalAssemblyCache))
    VARIANT_BOOL GlobalAssemblyCache;
    ...
    _TypePtr GetType ( );
    _bstr_t GetCodeBase ( );
    _bstr_t GetEscapedCodeBase ( );
    _AssemblyNamePtr GetName ( );
    _AssemblyNamePtr GetName_2 (
        VARIANT_BOOL copiedName );
    _bstr_t GetFullName ( );
    _MethodInfoPtr GetEntryPoint ( );
    _TypePtr GetType_2 (
        _bstr_t name );
    _TypePtr GetType_3 (
        _bstr_t name,
    ...
    SAFEARRAY * GetTypes ( );
    _StreamPtr GetManifestResourceStream (
        struct _Type * Type,
        _bstr_t name );
    _StreamPtr GetManifestResourceStream_2 (
        _bstr_t name );
    _FileStreamPtr GetFile (
        _bstr_t name );
    SAFEARRAY * GetFiles ( );
    SAFEARRAY * GetFiles_2 (
        VARIANT_BOOL getResourceModules );
    SAFEARRAY * GetManifestResourceNames ( );
    _ManifestResourceInfoPtr GetManifestResourceInfo (
    ...
    HRESULT add_ModuleResolve (
        struct _ModuleResolveEventHandler * value );
    ...
    _TypePtr GetType_4 (
        ...
        VARIANT_BOOL throwOnError,
        VARIANT_BOOL ignoreCase );
    _AssemblyPtr GetSatelliteAssembly (
        struct _CultureInfo * culture );
    _AssemblyPtr GetSatelliteAssembly_2 (
        struct _CultureInfo * culture,
        struct _Version * Version );
    _ModulePtr LoadModule (
        _bstr_t moduleName,
        SAFEARRAY * rawModule );
    _ModulePtr LoadModule_2 (
        _bstr_t moduleName,
        SAFEARRAY * rawModule,
        SAFEARRAY * rawSymbolStore );
    _variant_t CreateInstance (
        _bstr_t typeName );
    _variant_t CreateInstance_2 (
        _bstr_t typeName,
        VARIANT_BOOL ignoreCase );
    _variant_t CreateInstance_3 (
        _bstr_t typeName,
        VARIANT_BOOL ignoreCase,
        enum BindingFlags bindingAttr,
        struct _Binder * Binder,
    ...
    VARIANT_BOOL GetGlobalAssemblyCache ( );
    ...
    //
      ...
      virtual HRESULT __stdcall raw_GetName_2 (
      ...
      virtual HRESULT __stdcall get_EntryPoint (
        /*[out,retval]*/ struct _MethodInfo * * pRetVal ) = 0;
      virtual HRESULT __stdcall raw_GetType_2 (
        /*[in]*/ BSTR name,
        /*[out,retval]*/ struct _Type * * pRetVal ) = 0;
      virtual HRESULT __stdcall raw_GetType_3 (
        /*[in]*/ BSTR name,
        /*[in]*/ VARIANT_BOOL throwOnError,
        /*[out,retval]*/ struct _Type * * pRetVal ) = 0;
      virtual HRESULT __stdcall raw_GetExportedTypes (
        /*[out,retval]*/ SAFEARRAY * * pRetVal ) = 0;
      virtual HRESULT __stdcall raw_GetTypes (
        /*[out,retval]*/ SAFEARRAY * * pRetVal ) = 0;
      virtual HRESULT __stdcall raw_GetManifestResourceStream (
        /*[in]*/ struct _Type * Type,
        /*[in]*/ BSTR name,
        /*[out,retval]*/ struct _Stream * * pRetVal ) = 0;
      virtual HRESULT __stdcall raw_GetManifestResourceStream_2 (
        /*[in]*/ BSTR name,
        /*[out,retval]*/ struct _Stream * * pRetVal ) = 0;
      ...
      virtual HRESULT __stdcall raw_GetFiles (
        /*[out,retval]*/ SAFEARRAY * * pRetVal ) = 0;
      virtual HRESULT __stdcall raw_GetFiles_2 (
        /*[in]*/ VARIANT_BOOL getResourceModules,
        /*[out,retval]*/ SAFEARRAY * * pRetVal ) = 0;
      virtual HRESULT __stdcall raw_GetManifestResourceNames (
        /*[out,retval]*/ SAFEARRAY * * pRetVal ) = 0;
      virtual HRESULT __stdcall raw_GetManifestResourceInfo (
      ...
      virtual HRESULT __stdcall raw_GetObjectData (
        /*[in]*/ struct _SerializationInfo * info,
        /*[in]*/ struct StreamingContext Context ) = 0;
      virtual HRESULT __stdcall raw_add_ModuleResolve (
        /*[in]*/ struct _ModuleResolveEventHandler * value ) = 0;
      virtual HRESULT __stdcall raw_remove_ModuleResolve (
        /*[in]*/ struct _ModuleResolveEventHandler * value ) = 0;
      virtual HRESULT __stdcall raw_GetType_4 (
        /*[in]*/ BSTR name,
        /*[in]*/ VARIANT_BOOL throwOnError,
        /*[in]*/ VARIANT_BOOL ignoreCase,
        /*[out,retval]*/ struct _Type * * pRetVal ) = 0;
      virtual HRESULT __stdcall raw_GetSatelliteAssembly (
        /*[in]*/ struct _CultureInfo * culture,
        /*[out,retval]*/ struct _Assembly * * pRetVal ) = 0;
      virtual HRESULT __stdcall raw_GetSatelliteAssembly_2 (
        /*[in]*/ struct _CultureInfo * culture,
      ...
      virtual HRESULT __stdcall raw_LoadModule (
        ...
        /*[out,retval]*/ struct _Module * * pRetVal ) = 0;
      virtual HRESULT __stdcall raw_LoadModule_2 (
        /*[in]*/ BSTR moduleName,
        /*[in]*/ SAFEARRAY * rawModule,
        /*[in]*/ SAFEARRAY * rawSymbolStore,
        /*[out,retval]*/ struct _Module * * pRetVal ) = 0;
      ...
      virtual HRESULT __stdcall raw_CreateInstance_3 (
        ...
        /*[in]*/ SAFEARRAY * activationAttributes,
        /*[out,retval]*/ VARIANT * pRetVal ) = 0;
      virtual HRESULT __stdcall raw_GetLoadedModules (
        /*[out,retval]*/ SAFEARRAY * * pRetVal ) = 0;
      virtual HRESULT __stdcall raw_GetLoadedModules_2 (
        /*[in]*/ VARIANT_BOOL getResourceModules,
        /*[out,retval]*/ SAFEARRAY * * pRetVal ) = 0;
      virtual HRESULT __stdcall raw_GetModules (
        /*[out,retval]*/ SAFEARRAY * * pRetVal ) = 0;
      virtual HRESULT __stdcall raw_GetModules_2 (
        /*[in]*/ VARIANT_BOOL getResourceModules,
        /*[out,retval]*/ SAFEARRAY * * pRetVal ) = 0;
      virtual HRESULT __stdcall raw_GetModule (
        /*[in]*/ BSTR name,
        /*[out,retval]*/ struct _Module * * pRetVal ) = 0;
      virtual HRESULT __stdcall raw_GetReferencedAssemblies (
        /*[out,retval]*/ SAFEARRAY * * pRetVal ) = 0;
...
ITypeLibImporterNotifySink : IUnknown
{
    ...
    HRESULT __ReportEvent (
        enum ImporterEventKind eventKind,
        long eventCode,
        _bstr_t eventMsg );
    _AssemblyPtr ResolveRef (
        IUnknown * typeLib );
    ...
    //
      ...
      virtual HRESULT __stdcall raw___ReportEvent (
        /*[in]*/ enum ImporterEventKind eventKind,
        /*[in]*/ long eventCode,
        /*[in]*/ BSTR eventMsg ) = 0;
      virtual HRESULT __stdcall raw_ResolveRef (
        /*[in]*/ IUnknown * typeLib,
        /*[out,retval]*/ struct _Assembly * * pRetVal ) = 0;
};
...
IRegistrationServices : IDispatch
{
    ...
    VARIANT_BOOL RegisterAssembly (
        struct _Assembly * Assembly,
        enum AssemblyRegistrationFlags flags );
    VARIANT_BOOL UnregisterAssembly (
        struct _Assembly * Assembly );
    SAFEARRAY * GetRegistrableTypesInAssembly (
        struct _Assembly * Assembly );
    _bstr_t GetProgIdForType (
        struct _Type * Type );
    HRESULT RegisterTypeForComClients (
        struct _Type * Type,
        GUID * G );
    GUID GetManagedCategoryGuid ( );
    VARIANT_BOOL TypeRequiresRegistration (
        struct _Type * Type );
    VARIANT_BOOL TypeRepresentsComType (
        struct _Type * Type );
    ...
    //
      ...
      virtual HRESULT __stdcall raw_RegisterAssembly (
        /*[in]*/ struct _Assembly * Assembly,
        /*[in]*/ enum AssemblyRegistrationFlags flags,
        /*[out,retval]*/ VARIANT_BOOL * pRetVal ) = 0;
      virtual HRESULT __stdcall raw_UnregisterAssembly (
        /*[in]*/ struct _Assembly * Assembly,
        /*[out,retval]*/ VARIANT_BOOL * pRetVal ) = 0;
      virtual HRESULT __stdcall raw_GetRegistrableTypesInAssembly (
        /*[in]*/ struct _Assembly * Assembly,
        /*[out,retval]*/ SAFEARRAY * * pRetVal ) = 0;
      virtual HRESULT __stdcall raw_GetProgIdForType (
        /*[in]*/ struct _Type * Type,
        /*[out,retval]*/ BSTR * pRetVal ) = 0;
      virtual HRESULT __stdcall raw_RegisterTypeForComClients (
        /*[in]*/ struct _Type * Type,
        /*[in,out]*/ GUID * G ) = 0;
      virtual HRESULT __stdcall raw_GetManagedCategoryGuid (
        /*[out,retval]*/ GUID * pRetVal ) = 0;
      virtual HRESULT __stdcall raw_TypeRequiresRegistration (
        /*[in]*/ struct _Type * Type,
        /*[out,retval]*/ VARIANT_BOOL * pRetVal ) = 0;
      virtual HRESULT __stdcall raw_TypeRepresentsComType (
        /*[in]*/ struct _Type * Type,
        /*[out,retval]*/ VARIANT_BOOL * pRetVal ) = 0;
};
...
ITypeLibExporterNotifySink : IUnknown
{
    ...
    HRESULT __ReportEvent (
        enum ExporterEventKind eventKind,
        long eventCode,
        _bstr_t eventMsg );
    IUnknownPtr ResolveRef (
        struct _Assembly * Assembly );
...
ITypeLibConverter : IUnknown
{
    ...
    _AssemblyBuilderPtr ConvertTypeLibToAssembly (
        IUnknown * typeLib,
        _bstr_t asmFileName,
        enum TypeLibImporterFlags flags,
        struct ITypeLibImporterNotifySink * notifySink,
        SAFEARRAY * publicKey,
        struct _StrongNameKeyPair * keyPair,
        _bstr_t asmNamespace,
        struct _Version * asmVersion );
    IUnknownPtr ConvertAssemblyToTypeLib (
        struct _Assembly * Assembly,
        _bstr_t typeLibName,
        enum TypeLibExporterFlags flags,
        struct ITypeLibExporterNotifySink * notifySink );
    VARIANT_BOOL GetPrimaryInteropAssembly (
        GUID G,
        long major,
        long minor,
        long lcid,
        BSTR * asmName,
        BSTR * asmCodeBase );
    _AssemblyBuilderPtr ConvertTypeLibToAssembly_2 (
        IUnknown * typeLib,
        _bstr_t asmFileName,
        long flags,
        struct ITypeLibImporterNotifySink * notifySink,
    ...
    //
      ...
      virtual HRESULT __stdcall raw_ConvertTypeLibToAssembly (
        /*[in]*/ IUnknown * typeLib,
        /*[in]*/ BSTR asmFileName,
        ...
        /*[out,retval]*/ struct _AssemblyBuilder * * pRetVal ) = 0;
      virtual HRESULT __stdcall raw_ConvertAssemblyToTypeLib (
        /*[in]*/ struct _Assembly * Assembly,
        /*[in]*/ BSTR typeLibName,
        /*[in]*/ enum TypeLibExporterFlags flags,
        /*[in]*/ struct ITypeLibExporterNotifySink * notifySink,
        /*[out,retval]*/ IUnknown * * pRetVal ) = 0;
      virtual HRESULT __stdcall raw_GetPrimaryInteropAssembly (
        /*[in]*/ GUID G,
        /*[in]*/ long major,
        /*[in]*/ long minor,
        /*[in]*/ long lcid,
        ...
        /*[out,retval]*/ VARIANT_BOOL * pRetVal ) = 0;
      virtual HRESULT __stdcall raw_ConvertTypeLibToAssembly_2 (
        /*[in]*/ IUnknown * typeLib,
        /*[in]*/ BSTR asmFileName,
        /*[in]*/ long flags,
        /*[in]*/ struct ITypeLibImporterNotifySink * notifySink,
...
_MethodBase : IUnknown
{
    ...
    __declspec(property(get=GetIsSpecialName))
    VARIANT_BOOL IsSpecialName;
    __declspec(property(get=GetIsConstructor))
    VARIANT_BOOL IsConstructor;
    __declspec(property(get=GetMemberType))
    enum MemberTypes MemberType;
    __declspec(property(get=Getname))
    _bstr_t name;
    ...
    __declspec(property(get=GetReflectedType))
    _TypePtr ReflectedType;
    __declspec(property(get=GetMethodHandle))
    struct RuntimeMethodHandle MethodHandle;
    __declspec(property(get=GetAttributes))
    enum MethodAttributes Attributes;
    __declspec(property(get=GetCallingConvention))
    enum CallingConventions CallingConvention;
    __declspec(property(get=GetIsPublic))
    VARIANT_BOOL IsPublic;
    __declspec(property(get=GetIsPrivate))
    VARIANT_BOOL IsPrivate;
    __declspec(property(get=GetIsFamily))
    VARIANT_BOOL IsFamily;
    __declspec(property(get=GetIsAssembly))
    VARIANT_BOOL IsAssembly;
    __declspec(property(get=GetIsFamilyAndAssembly))
    VARIANT_BOOL IsFamilyAndAssembly;
    __declspec(property(get=GetIsFamilyOrAssembly))
    VARIANT_BOOL IsFamilyOrAssembly;
    __declspec(property(get=GetIsStatic))
    VARIANT_BOOL IsStatic;
    __declspec(property(get=GetIsFinal))
    VARIANT_BOOL IsFinal;
    __declspec(property(get=GetIsVirtual))
    VARIANT_BOOL IsVirtual;
    __declspec(property(get=GetIsHideBySig))
    VARIANT_BOOL IsHideBySig;
    __declspec(property(get=GetIsAbstract))
    VARIANT_BOOL IsAbstract;
    ...
    VARIANT_BOOL IsDefined (
        ...
        VARIANT_BOOL inherit );
    SAFEARRAY * GetParameters ( );
    enum MethodImplAttributes GetMethodImplementationFlags ( );
    struct RuntimeMethodHandle GetMethodHandle ( );
    enum MethodAttributes GetAttributes ( );
    enum CallingConventions GetCallingConvention ( );
    _variant_t Invoke_2 (
        const _variant_t & obj,
        enum BindingFlags invokeAttr,
        struct _Binder * Binder,
    ...
    VARIANT_BOOL GetIsFamily ( );
    VARIANT_BOOL GetIsAssembly ( );
    VARIANT_BOOL GetIsFamilyAndAssembly ( );
    VARIANT_BOOL GetIsFamilyOrAssembly ( );
    VARIANT_BOOL GetIsStatic ( );
    VARIANT_BOOL GetIsFinal ( );
    VARIANT_BOOL GetIsVirtual ( );
    VARIANT_BOOL GetIsHideBySig ( );
    VARIANT_BOOL GetIsAbstract ( );
    VARIANT_BOOL GetIsSpecialName ( );
    VARIANT_BOOL GetIsConstructor ( );
    _variant_t Invoke_3 (
        const _variant_t & obj,
        SAFEARRAY * parameters );
    ...
    //
      ...
      virtual HRESULT __stdcall raw_GetParameters (
        /*[out,retval]*/ SAFEARRAY * * pRetVal ) = 0;
      virtual HRESULT __stdcall raw_GetMethodImplementationFlags (
      ...
      virtual HRESULT __stdcall get_IsConstructor (
        /*[out,retval]*/ VARIANT_BOOL * pRetVal ) = 0;
      virtual HRESULT __stdcall raw_Invoke_3 (
        /*[in]*/ VARIANT obj,
        /*[in]*/ SAFEARRAY * parameters,
        /*[out,retval]*/ VARIANT * pRetVal ) = 0;
};
...
IMethodMessage : IDispatch
{
    ...
    _bstr_t typeName;
    __declspec(property(get=GetMethodSignature))
    _variant_t MethodSignature;
    __declspec(property(get=GetArgCount))
    long ArgCount;
    __declspec(property(get=Getargs))
    SAFEARRAY * args;
    __declspec(property(get=GetHasVarArgs))
    VARIANT_BOOL HasVarArgs;
    __declspec(property(get=GetLogicalCallContext))
    _LogicalCallContextPtr LogicalCallContext;
    __declspec(property(get=GetMethodBase))
    _MethodBasePtr MethodBase;
    ...
    _variant_t GetArg (
        long argNum );
    SAFEARRAY * Getargs ( );
    VARIANT_BOOL GetHasVarArgs ( );
    _LogicalCallContextPtr GetLogicalCallContext ( );
    _MethodBasePtr GetMethodBase ( );
    ...
    //
      ...
      virtual HRESULT __stdcall get_ArgCount (
        /*[out,retval]*/ long * pRetVal ) = 0;
      virtual HRESULT __stdcall raw_GetArgName (
        /*[in]*/ long index,
        /*[out,retval]*/ BSTR * pRetVal ) = 0;
      virtual HRESULT __stdcall raw_GetArg (
        /*[in]*/ long argNum,
        /*[out,retval]*/ VARIANT * pRetVal ) = 0;
...
_MethodInfo : IUnknown
{
    ...
    _TypePtr returnType;
    __declspec(property(get=GetReturnTypeCustomAttributes))
    ICustomAttributeProviderPtr ReturnTypeCustomAttributes;
    ...
    _variant_t Invoke_3 (
        const _variant_t & obj,
        SAFEARRAY * parameters );
    _TypePtr GetreturnType ( );
    ICustomAttributeProviderPtr GetReturnTypeCustomAttributes ( );
    _MethodInfoPtr GetBaseDefinition ( );
    ...
    //
      ...
      virtual HRESULT __stdcall raw_GetBaseDefinition (
        /*[out,retval]*/ struct _MethodInfo * * pRetVal ) = 0;
};
...
_EventInfo : IUnknown
{
    ...
    _TypePtr ReflectedType;
    __declspec(property(get=GetAttributes))
    enum EventAttributes Attributes;
    __declspec(property(get=GetEventHandlerType))
    _TypePtr EventHandlerType;
    __declspec(property(get=GetIsSpecialName))
    VARIANT_BOOL IsSpecialName;
    __declspec(property(get=GetIsMulticast))
    VARIANT_BOOL IsMulticast;
    ...
    VARIANT_BOOL IsDefined (
        struct _Type * attributeType,
        VARIANT_BOOL inherit );
    _MethodInfoPtr GetAddMethod (
        VARIANT_BOOL nonPublic );
    _MethodInfoPtr GetRemoveMethod (
        VARIANT_BOOL nonPublic );
    _MethodInfoPtr GetRaiseMethod (
        VARIANT_BOOL nonPublic );
    enum EventAttributes GetAttributes ( );
    _MethodInfoPtr GetAddMethod_2 ( );
    _MethodInfoPtr GetRemoveMethod_2 ( );
    _MethodInfoPtr GetRaiseMethod_2 ( );
    HRESULT AddEventHandler (
        const _variant_t & Target,
        struct _Delegate * handler );
    HRESULT RemoveEventHandler (
        const _variant_t & Target,
        struct _Delegate * handler );
    _TypePtr GetEventHandlerType ( );
    VARIANT_BOOL GetIsSpecialName ( );
    VARIANT_BOOL GetIsMulticast ( );
    ...
    //
      ...
      virtual HRESULT __stdcall raw_IsDefined (
        ...
        /*[in]*/ VARIANT_BOOL inherit,
        /*[out,retval]*/ VARIANT_BOOL * pRetVal ) = 0;
      virtual HRESULT __stdcall raw_GetAddMethod (
        /*[in]*/ VARIANT_BOOL nonPublic,
        /*[out,retval]*/ struct _MethodInfo * * pRetVal ) = 0;
      virtual HRESULT __stdcall raw_GetRemoveMethod (
        /*[in]*/ VARIANT_BOOL nonPublic,
        /*[out,retval]*/ struct _MethodInfo * * pRetVal ) = 0;
      virtual HRESULT __stdcall raw_GetRaiseMethod (
        /*[in]*/ VARIANT_BOOL nonPublic,
        /*[out,retval]*/ struct _MethodInfo * * pRetVal ) = 0;
      virtual HRESULT __stdcall get_Attributes (
        /*[out,retval]*/ enum EventAttributes * pRetVal ) = 0;
      virtual HRESULT __stdcall raw_GetAddMethod_2 (
        /*[out,retval]*/ struct _MethodInfo * * pRetVal ) = 0;
      virtual HRESULT __stdcall raw_GetRemoveMethod_2 (
        /*[out,retval]*/ struct _MethodInfo * * pRetVal ) = 0;
      virtual HRESULT __stdcall raw_GetRaiseMethod_2 (
        /*[out,retval]*/ struct _MethodInfo * * pRetVal ) = 0;
      virtual HRESULT __stdcall raw_AddEventHandler (
        /*[in]*/ VARIANT Target,
        /*[in]*/ struct _Delegate * handler ) = 0;
      virtual HRESULT __stdcall raw_RemoveEventHandler (
        /*[in]*/ VARIANT Target,
        /*[in]*/ struct _Delegate * handler ) = 0;
...
_ConstructorInfo : IUnknown
{
    ...
    //
      ...
      virtual HRESULT __stdcall raw_Invoke_3 (
        ...
        /*[in]*/ SAFEARRAY * parameters,
        /*[out,retval]*/ VARIANT * pRetVal ) = 0;
      virtual HRESULT __stdcall raw_Invoke_4 (
        /*[in]*/ enum BindingFlags invokeAttr,
        /*[in]*/ struct _Binder * Binder,
        /*[in]*/ SAFEARRAY * parameters,
        /*[in]*/ struct _CultureInfo * culture,
        /*[out,retval]*/ VARIANT * pRetVal ) = 0;
      virtual HRESULT __stdcall raw_Invoke_5 (
        /*[in]*/ SAFEARRAY * parameters,
        /*[out,retval]*/ VARIANT * pRetVal ) = 0;
};
...
_FieldInfo : IUnknown
{
    ...
    __declspec(property(get=GetToString))
    _bstr_t ToString;
    __declspec(property(get=GetIsNotSerialized))
    VARIANT_BOOL IsNotSerialized;
    __declspec(property(get=GetIsSpecialName))
    VARIANT_BOOL IsSpecialName;
    __declspec(property(get=GetIsPinvokeImpl))
    VARIANT_BOOL IsPinvokeImpl;
    __declspec(property(get=GetMemberType))
    enum MemberTypes MemberType;
    __declspec(property(get=Getname))
    _bstr_t name;
    ...
    _TypePtr FieldType;
    __declspec(property(get=GetFieldHandle))
    struct RuntimeFieldHandle FieldHandle;
    __declspec(property(get=GetAttributes))
    enum FieldAttributes Attributes;
    __declspec(property(get=GetIsPublic))
    VARIANT_BOOL IsPublic;
    ...
    __declspec(property(get=GetIsStatic))
    VARIANT_BOOL IsStatic;
    __declspec(property(get=GetIsInitOnly))
    VARIANT_BOOL IsInitOnly;
    __declspec(property(get=GetIsLiteral))
    VARIANT_BOOL IsLiteral;
    ...
    VARIANT_BOOL IsDefined (
        struct _Type * attributeType,
        VARIANT_BOOL inherit );
    _TypePtr GetFieldType ( );
    _variant_t GetValue (
        const _variant_t & obj );
    _variant_t GetValueDirect (
        const _variant_t & obj );
    HRESULT SetValue (
        const _variant_t & obj,
        const _variant_t & value,
    ...
    HRESULT SetValueDirect (
        const _variant_t & obj,
        const _variant_t & value );
    struct RuntimeFieldHandle GetFieldHandle ( );
    enum FieldAttributes GetAttributes ( );
    HRESULT SetValue_2 (
        const _variant_t & obj,
        const _variant_t & value );
    VARIANT_BOOL GetIsPublic ( );
    ...
    VARIANT_BOOL GetIsFamilyOrAssembly ( );
    VARIANT_BOOL GetIsStatic ( );
    VARIANT_BOOL GetIsInitOnly ( );
    VARIANT_BOOL GetIsLiteral ( );
    VARIANT_BOOL GetIsNotSerialized ( );
    VARIANT_BOOL GetIsSpecialName ( );
    VARIANT_BOOL GetIsPinvokeImpl ( );
    ...
    //
      ...
      virtual HRESULT __stdcall raw_GetValue (
        /*[in]*/ VARIANT obj,
        /*[out,retval]*/ VARIANT * pRetVal ) = 0;
      virtual HRESULT __stdcall raw_GetValueDirect (
        /*[in]*/ VARIANT obj,
        /*[out,retval]*/ VARIANT * pRetVal ) = 0;
      ...
      virtual HRESULT __stdcall raw_SetValueDirect (
        /*[in]*/ VARIANT obj,
        /*[in]*/ VARIANT value ) = 0;
      ...
      virtual HRESULT __stdcall raw_SetValue_2 (
        /*[in]*/ VARIANT obj,
        /*[in]*/ VARIANT value ) = 0;
      virtual HRESULT __stdcall get_IsPublic (
        /*[out,retval]*/ VARIANT_BOOL * pRetVal ) = 0;
...
_PropertyInfo : IUnknown
{
    ...
    _TypePtr PropertyType;
    __declspec(property(get=GetAttributes))
    enum PropertyAttributes Attributes;
    __declspec(property(get=GetCanRead))
    VARIANT_BOOL CanRead;
    __declspec(property(get=GetCanWrite))
    VARIANT_BOOL CanWrite;
    __declspec(property(get=GetIsSpecialName))
    VARIANT_BOOL IsSpecialName;
    ...
    VARIANT_BOOL IsDefined (
        struct _Type * attributeType,
        VARIANT_BOOL inherit );
    _TypePtr GetPropertyType ( );
    _variant_t GetValue (
        const _variant_t & obj,
        SAFEARRAY * index );
    _variant_t GetValue_2 (
        const _variant_t & obj,
        enum BindingFlags invokeAttr,
        struct _Binder * Binder,
        SAFEARRAY * index,
    ...
    SAFEARRAY * GetAccessors (
        VARIANT_BOOL nonPublic );
    _MethodInfoPtr GetGetMethod (
        VARIANT_BOOL nonPublic );
    _MethodInfoPtr GetSetMethod (
        VARIANT_BOOL nonPublic );
    SAFEARRAY * GetIndexParameters ( );
    enum PropertyAttributes GetAttributes ( );
    VARIANT_BOOL GetCanRead ( );
    VARIANT_BOOL GetCanWrite ( );
    SAFEARRAY * GetAccessors_2 ( );
    _MethodInfoPtr GetGetMethod_2 ( );
    _MethodInfoPtr GetSetMethod_2 ( );
    VARIANT_BOOL GetIsSpecialName ( );
    ...
    //
      ...
      virtual HRESULT __stdcall raw_GetValue (
        ...
        /*[in]*/ SAFEARRAY * index,
        /*[out,retval]*/ VARIANT * pRetVal ) = 0;
      virtual HRESULT __stdcall raw_GetValue_2 (
        /*[in]*/ VARIANT obj,
        /*[in]*/ enum BindingFlags invokeAttr,
        /*[in]*/ struct _Binder * Binder,
        /*[in]*/ SAFEARRAY * index,
      ...
      virtual HRESULT __stdcall raw_SetValue_2 (
        ...
        /*[in]*/ SAFEARRAY * index,
        /*[in]*/ struct _CultureInfo * culture ) = 0;
      virtual HRESULT __stdcall raw_GetAccessors (
        /*[in]*/ VARIANT_BOOL nonPublic,
        /*[out,retval]*/ SAFEARRAY * * pRetVal ) = 0;
      virtual HRESULT __stdcall raw_GetGetMethod (
        /*[in]*/ VARIANT_BOOL nonPublic,
        /*[out,retval]*/ struct _MethodInfo * * pRetVal ) = 0;
      virtual HRESULT __stdcall raw_GetSetMethod (
        /*[in]*/ VARIANT_BOOL nonPublic,
        /*[out,retval]*/ struct _MethodInfo * * pRetVal ) = 0;
      virtual HRESULT __stdcall raw_GetIndexParameters (
        /*[out,retval]*/ SAFEARRAY * * pRetVal ) = 0;
      virtual HRESULT __stdcall get_Attributes (
      ...
      virtual HRESULT __stdcall get_CanWrite (
        /*[out,retval]*/ VARIANT_BOOL * pRetVal ) = 0;
      virtual HRESULT __stdcall raw_GetAccessors_2 (
        /*[out,retval]*/ SAFEARRAY * * pRetVal ) = 0;
      virtual HRESULT __stdcall raw_GetGetMethod_2 (
        /*[out,retval]*/ struct _MethodInfo * * pRetVal ) = 0;
      virtual HRESULT __stdcall raw_GetSetMethod_2 (
        /*[out,retval]*/ struct _MethodInfo * * pRetVal ) = 0;
      virtual HRESULT __stdcall get_IsSpecialName (
        /*[out,retval]*/ VARIANT_BOOL * pRetVal ) = 0;
};
...
IExpando : IDispatch
{
    ...
    _FieldInfoPtr AddField (
        _bstr_t name );
    _PropertyInfoPtr AddProperty (
        _bstr_t name );
    _MethodInfoPtr AddMethod (
        _bstr_t name,
        struct _Delegate * Method );
    HRESULT RemoveMember (
        struct _MemberInfo * m );
    ...
    //
      ...
      virtual HRESULT __stdcall raw_AddProperty (
        /*[in]*/ BSTR name,
        /*[out,retval]*/ struct _PropertyInfo * * pRetVal ) = 0;
      virtual HRESULT __stdcall raw_AddMethod (
        /*[in]*/ BSTR name,
...
_Binder : IDispatch
{
    ...
    _MethodBasePtr BindToMethod (
        ...
        SAFEARRAY * names,
        VARIANT * state );
    _FieldInfoPtr BindToField (
        enum BindingFlags bindingAttr,
        SAFEARRAY * match,
        const _variant_t & value,
        struct _CultureInfo * culture );
    _MethodBasePtr SelectMethod (
        enum BindingFlags bindingAttr,
        SAFEARRAY * match,
        SAFEARRAY * types,
        SAFEARRAY * modifiers );
    _PropertyInfoPtr SelectProperty (
        enum BindingFlags bindingAttr,
        SAFEARRAY * match,
        struct _Type * returnType,
        SAFEARRAY * indexes,
    ...
    //
      ...
      virtual HRESULT __stdcall raw_GetType (
        /*[out,retval]*/ struct _Type * * pRetVal ) = 0;
      virtual HRESULT __stdcall raw_BindToMethod (
        /*[in]*/ enum BindingFlags bindingAttr,
        /*[in]*/ SAFEARRAY * match,
        ...
        /*[out]*/ VARIANT * state,
        /*[out,retval]*/ struct _MethodBase * * pRetVal ) = 0;
      virtual HRESULT __stdcall raw_BindToField (
        /*[in]*/ enum BindingFlags bindingAttr,
        /*[in]*/ SAFEARRAY * match,
        /*[in]*/ VARIANT value,
        /*[in]*/ struct _CultureInfo * culture,
        /*[out,retval]*/ struct _FieldInfo * * pRetVal ) = 0;
      virtual HRESULT __stdcall raw_SelectMethod (
        /*[in]*/ enum BindingFlags bindingAttr,
        /*[in]*/ SAFEARRAY * match,
        /*[in]*/ SAFEARRAY * types,
        /*[in]*/ SAFEARRAY * modifiers,
        /*[out,retval]*/ struct _MethodBase * * pRetVal ) = 0;
      virtual HRESULT __stdcall raw_SelectProperty (
        /*[in]*/ enum BindingFlags bindingAttr,
        /*[in]*/ SAFEARRAY * match,
        /*[in]*/ struct _Type * returnType,
      ...
      virtual HRESULT __stdcall raw_ChangeType (
        ...
        /*[in]*/ struct _CultureInfo * culture,
        /*[out,retval]*/ VARIANT * pRetVal ) = 0;
      virtual HRESULT __stdcall raw_ReorderArgumentArray (
        /*[in,out]*/ SAFEARRAY * * args,
        /*[in]*/ VARIANT state ) = 0;
};
...
IFormatter : IDispatch
{
    ...
    __declspec(property(get=GetSurrogateSelector,put=PutRefSurrogateSelector))
    ISurrogateSelectorPtr SurrogateSelector;
    __declspec(property(get=GetBinder,put=PutRefBinder))
    _SerializationBinderPtr Binder;
    ...
    HRESULT Serialize (
        struct _Stream * serializationStream,
        const _variant_t & graph );
    ISurrogateSelectorPtr GetSurrogateSelector ( );
    void PutRefSurrogateSelector (
        struct ISurrogateSelector * pRetVal );
    _SerializationBinderPtr GetBinder ( );
    void PutRefBinder (
        struct _SerializationBinder * pRetVal );
    struct StreamingContext GetContext ( );
    void PutContext (
        struct StreamingContext pRetVal );
...
ISerializationSurrogate : IDispatch
{
    ...
    HRESULT GetObjectData (
        ...
        struct _SerializationInfo * info,
        struct StreamingContext Context );
    _variant_t SetObjectData (
        const _variant_t & obj,
        struct _SerializationInfo * info,
        struct StreamingContext Context,
        struct ISurrogateSelector * selector );
    ...
    //
      ...
      virtual HRESULT __stdcall raw_GetObjectData (
        ...
        /*[in]*/ struct _SerializationInfo * info,
        /*[in]*/ struct StreamingContext Context ) = 0;
      virtual HRESULT __stdcall raw_SetObjectData (
        /*[in]*/ VARIANT obj,
        /*[in]*/ struct _SerializationInfo * info,
        /*[in]*/ struct StreamingContext Context,
...
ISurrogateSelector : IDispatch
{
    ...
    HRESULT ChainSelector (
        struct ISurrogateSelector * selector );
    ISerializationSurrogatePtr GetSurrogate (
        struct _Type * Type,
        struct StreamingContext Context,
        struct ISurrogateSelector * * selector );
    ISurrogateSelectorPtr GetNextSelector ( );

    //
    // Raw methods provided by interface
    //

      virtual HRESULT __stdcall raw_ChainSelector (
        /*[in]*/ struct ISurrogateSelector * selector ) = 0;
      virtual HRESULT __stdcall raw_GetSurrogate (
        /*[in]*/ struct _Type * Type,
        /*[in]*/ struct StreamingContext Context,
        /*[out]*/ struct ISurrogateSelector * * selector,
        /*[out,retval]*/ struct ISerializationSurrogate * * pRetVal ) = 0;
      virtual HRESULT __stdcall raw_GetNextSelector (
        /*[out,retval]*/ struct ISurrogateSelector * * pRetVal ) = 0;
};
...
IContextAttribute : IDispatch
{
    ...
    VARIANT_BOOL IsContextOK (
        struct _Context * ctx,
        struct IConstructionCallMessage * msg );
    HRESULT GetPropertiesForNewContext (
        struct IConstructionCallMessage * msg );
    ...
    //
      ...
      virtual HRESULT __stdcall raw_IsContextOK (
        /*[in]*/ struct _Context * ctx,
        /*[in]*/ struct IConstructionCallMessage * msg,
        /*[out,retval]*/ VARIANT_BOOL * pRetVal ) = 0;
      virtual HRESULT __stdcall raw_GetPropertiesForNewContext (
...
IActivator : IDispatch
{
    ...
    __declspec(property(get=GetNextActivator,put=PutRefNextActivator))
    IActivatorPtr NextActivator;
    __declspec(property(get=Getlevel))
    enum ActivatorLevel level;

    //
    // Wrapper methods for error-handling
    //

    IActivatorPtr GetNextActivator ( );
    void PutRefNextActivator (
        struct IActivator * pRetVal );
    IConstructionReturnMessagePtr Activate (
        struct IConstructionCallMessage * msg );
    enum ActivatorLevel Getlevel ( );
...
IConstructionCallMessage : IDispatch
{
    ...
    __declspec(property(get=GetActivator,put=PutRefActivator))
    IActivatorPtr Activator;
    __declspec(property(get=GetCallSiteActivationAttributes))
    SAFEARRAY * CallSiteActivationAttributes;
    __declspec(property(get=GetActivationTypeName))
    _bstr_t ActivationTypeName;
    __declspec(property(get=GetActivationType))
    _TypePtr ActivationType;
    __declspec(property(get=GetContextProperties))
    IListPtr ContextProperties;

    //
    // Wrapper methods for error-handling
    //

    IActivatorPtr GetActivator ( );
    void PutRefActivator (
        struct IActivator * pRetVal );
    SAFEARRAY * GetCallSiteActivationAttributes ( );
    _bstr_t GetActivationTypeName ( );
    _TypePtr GetActivationType ( );
    IListPtr GetContextProperties ( );
...
IContextPropertyActivator : IDispatch
{
    ...
    VARIANT_BOOL IsOKToActivate (
        struct IConstructionCallMessage * msg );
    HRESULT CollectFromClientContext (
        struct IConstructionCallMessage * msg );
    VARIANT_BOOL DeliverClientContextToServerContext (
        struct IConstructionCallMessage * msg );
    HRESULT CollectFromServerContext (
        struct IConstructionReturnMessage * msg );
    VARIANT_BOOL DeliverServerContextToClientContext (
        struct IConstructionReturnMessage * msg );
    ...
    //
      ...
      virtual HRESULT __stdcall raw_IsOKToActivate (
        /*[in]*/ struct IConstructionCallMessage * msg,
        /*[out,retval]*/ VARIANT_BOOL * pRetVal ) = 0;
      virtual HRESULT __stdcall raw_CollectFromClientContext (
        /*[in]*/ struct IConstructionCallMessage * msg ) = 0;
      virtual HRESULT __stdcall raw_DeliverClientContextToServerContext (
        /*[in]*/ struct IConstructionCallMessage * msg,
        /*[out,retval]*/ VARIANT_BOOL * pRetVal ) = 0;
      virtual HRESULT __stdcall raw_CollectFromServerContext (
        /*[in]*/ struct IConstructionReturnMessage * msg ) = 0;
      virtual HRESULT __stdcall raw_DeliverServerContextToClientContext (
...
IClientChannelSinkStack : IDispatch
{
    ...
    HRESULT Push (
        struct IClientChannelSink * sink,
        const _variant_t & state );
    _variant_t Pop (
        struct IClientChannelSink * sink );
    ...
    //
      ...
      virtual HRESULT __stdcall raw_Push (
        ...
        /*[in]*/ VARIANT state ) = 0;
      virtual HRESULT __stdcall raw_Pop (
        /*[in]*/ struct IClientChannelSink * sink,
        /*[out,retval]*/ VARIANT * pRetVal ) = 0;
};
...
IClientChannelSink : IDispatch
{
    ...
    __declspec(property(get=GetNextChannelSink))
    IClientChannelSinkPtr NextChannelSink;
    ...
    HRESULT ProcessMessage (
        struct IMessage * msg,
        struct ITransportHeaders * requestHeaders,
        struct _Stream * requestStream,
        struct ITransportHeaders * * responseHeaders,
        struct _Stream * * responseStream );
    HRESULT AsyncProcessRequest (
        struct IClientChannelSinkStack * sinkStack,
        struct IMessage * msg,
        struct ITransportHeaders * headers,
        struct _Stream * Stream );
    HRESULT AsyncProcessResponse (
        struct IClientResponseChannelSinkStack * sinkStack,
        const _variant_t & state,
        struct ITransportHeaders * headers,
        struct _Stream * Stream );
    _StreamPtr GetRequestStream (
        struct IMessage * msg,
        struct ITransportHeaders * headers );
    IClientChannelSinkPtr GetNextChannelSink ( );

    //
    // Raw methods provided by interface
    //

      virtual HRESULT __stdcall raw_ProcessMessage (
        /*[in]*/ struct IMessage * msg,
      ...
      virtual HRESULT __stdcall raw_AsyncProcessRequest (
      ...
      virtual HRESULT __stdcall raw_AsyncProcessResponse (
        ...
        /*[in]*/ struct ITransportHeaders * headers,
        /*[in]*/ struct _Stream * Stream ) = 0;
      virtual HRESULT __stdcall raw_GetRequestStream (
        /*[in]*/ struct IMessage * msg,
        /*[in]*/ struct ITransportHeaders * headers,
        /*[out,retval]*/ struct _Stream * * pRetVal ) = 0;
...
IClientChannelSinkProvider : IDispatch
{
    ...
    __declspec(property(get=GetNext,put=PutRefNext))
    IClientChannelSinkProviderPtr Next;

    //
    // Wrapper methods for error-handling
    //

    IClientChannelSinkPtr CreateSink (
        struct IChannelSender * channel,
        _bstr_t Url,
        const _variant_t & remoteChannelData );
    IClientChannelSinkProviderPtr GetNext ( );
    void PutRefNext (
        struct IClientChannelSinkProvider * pRetVal );

    //
    // Raw methods provided by interface
    //

      virtual HRESULT __stdcall raw_CreateSink (
...
IServerChannelSinkStack : IDispatch
{
    ...
    HRESULT Push (
        struct IServerChannelSink * sink,
        const _variant_t & state );
    _variant_t Pop (
        struct IServerChannelSink * sink );
    HRESULT Store (
        struct IServerChannelSink * sink,
        const _variant_t & state );
    HRESULT StoreAndDispatch (
        struct IServerChannelSink * sink,
        const _variant_t & state );
    HRESULT ServerCallback (
        struct IAsyncResult * ar );
    ...
    //
      ...
      virtual HRESULT __stdcall raw_Store (
        /*[in]*/ struct IServerChannelSink * sink,
        /*[in]*/ VARIANT state ) = 0;
      virtual HRESULT __stdcall raw_StoreAndDispatch (
        /*[in]*/ struct IServerChannelSink * sink,
        /*[in]*/ VARIANT state ) = 0;
      virtual HRESULT __stdcall raw_ServerCallback (
...
IServerChannelSink : IDispatch
{
    ...
    __declspec(property(get=GetNextChannelSink))
    IServerChannelSinkPtr NextChannelSink;

    //
    // Wrapper methods for error-handling
    //

    enum ServerProcessing ProcessMessage (
        struct IServerChannelSinkStack * sinkStack,
        struct IMessage * requestMsg,
        struct ITransportHeaders * requestHeaders,
        struct _Stream * requestStream,
        struct IMessage * * responseMsg,
        struct ITransportHeaders * * responseHeaders,
        struct _Stream * * responseStream );
    HRESULT AsyncProcessResponse (
        struct IServerResponseChannelSinkStack * sinkStack,
        const _variant_t & state,
        struct IMessage * msg,
        struct ITransportHeaders * headers,
        struct _Stream * Stream );
    _StreamPtr GetResponseStream (
        ...
        struct IMessage * msg,
        struct ITransportHeaders * headers );
    IServerChannelSinkPtr GetNextChannelSink ( );
...
IServerChannelSinkProvider : IDispatch
{
    ...
    __declspec(property(get=GetNext,put=PutRefNext))
    IServerChannelSinkProviderPtr Next;

    //
    // Wrapper methods for error-handling
    //

    HRESULT GetChannelData (
        struct IChannelDataStore * ChannelData );
    IServerChannelSinkPtr CreateSink (
        struct IChannelReceiver * channel );
    IServerChannelSinkProviderPtr GetNext ( );
    void PutRefNext (
        struct IServerChannelSinkProvider * pRetVal );
...
IChannelReceiverHook : IDispatch
{
    ...
    __declspec(property(get=GetChannelScheme))
    _bstr_t ChannelScheme;
    __declspec(property(get=GetWantsToListen))
    VARIANT_BOOL WantsToListen;
    __declspec(property(get=GetChannelSinkChain))
    IServerChannelSinkPtr ChannelSinkChain;

    //
    // Wrapper methods for error-handling
    //

    _bstr_t GetChannelScheme ( );
    VARIANT_BOOL GetWantsToListen ( );
    IServerChannelSinkPtr GetChannelSinkChain ( );
    ...
    //
      ...
      virtual HRESULT __stdcall get_ChannelSinkChain (
        /*[out,retval]*/ struct IServerChannelSink * * pRetVal ) = 0;
      virtual HRESULT __stdcall raw_AddHookChannelUri (
...
ISponsor : IDispatch
{
    ...
    //
      ...
      virtual HRESULT __stdcall raw_Renewal (
...
ILease : IDispatch
{
    ...
    __declspec(property(get=GetRenewOnCallTime,put=PutRenewOnCallTime))
    struct TimeSpan RenewOnCallTime;
    __declspec(property(get=GetSponsorshipTimeout,put=PutSponsorshipTimeout))
    struct TimeSpan SponsorshipTimeout;
    __declspec(property(get=GetInitialLeaseTime,put=PutInitialLeaseTime))
    struct TimeSpan InitialLeaseTime;
    __declspec(property(get=GetCurrentLeaseTime))
    struct TimeSpan CurrentLeaseTime;
    __declspec(property(get=GetCurrentState))
    enum LeaseState CurrentState;
    ...
    HRESULT Register (
        struct ISponsor * obj,
        struct TimeSpan renewalTime );
    HRESULT Register_2 (
        struct ISponsor * obj );
    HRESULT Unregister (
        struct ISponsor * obj );
    struct TimeSpan Renew (
        struct TimeSpan renewalTime );
    struct TimeSpan GetRenewOnCallTime ( );
    void PutRenewOnCallTime (
        struct TimeSpan pRetVal );
    struct TimeSpan GetSponsorshipTimeout ( );
    void PutSponsorshipTimeout (
        struct TimeSpan pRetVal );
    struct TimeSpan GetInitialLeaseTime ( );
    void PutInitialLeaseTime (
        struct TimeSpan pRetVal );
    struct TimeSpan GetCurrentLeaseTime ( );
    enum LeaseState GetCurrentState ( );
    ...
    //
      ...
      virtual HRESULT __stdcall raw_Register_2 (
        /*[in]*/ struct ISponsor * obj ) = 0;
      virtual HRESULT __stdcall raw_Unregister (
        /*[in]*/ struct ISponsor * obj ) = 0;
      virtual HRESULT __stdcall raw_Renew (
