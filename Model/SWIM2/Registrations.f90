module Registrations
   ...
   contains
      ...
      dummy = add_reg(respondToGetReg, 'Ks', doublearrayTypeDDML, 'mm/d', 'Saturated soil hydraulic conductivity')
      ...
      dummy = add_reg(respondToGetSetReg, 'flow', doublearrayTypeDDML, 'mm', 'Flow of water from each layer')
      ...
      dummy = add_reg(respondToGetReg, 'subsurface_drain_x', doubleTypeDDML, 'kg/ha', 'Amount of x (no3, urea, etc) leached through drains')
      dummy = add_reg(respondToGetReg, 'pond_x', doubleTypeDDML, 'kg/ha', 'Amount of x (no3, urea, etc) in ponded water')
