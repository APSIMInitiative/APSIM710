...
void Water::doRegistrations(void)
   ...
   scienceAPI.expose("WaterStressPhoto",       "",   "Water stress factor for photosynthesis",          false, photoStress);
   scienceAPI.expose("WaterStressPheno",       "",   "Water stress factor for phenology",               false, phenoStress);
   scienceAPI.expose("WaterStressExpansion",       "",   "Water stress factor for leaf expansion growth",   false, expansionStress);
