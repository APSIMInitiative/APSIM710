module Registrations
   ...
   contains
      ...
      subroutine doRegistrations(id)
         ...
         id%canopy_water_balance = add_registration(eventReg, 'canopy_water_balance', nullTypeDDML, '')
         ...
         id%new_canopy = add_registration(respondToEventReg, 'new_canopy', nullTypeDDML, '')
