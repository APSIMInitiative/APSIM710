...
abstract public class Arbitrator : Instance
   ...
   virtual public void DoDM(Organ[] Organs) { }  // method called by parent plant to tell arbitrator to do DM arbitration.
   virtual public void DoN(Organ[] Organs) { }  // method called by parent plant to tell arbitrator to do N arbitration.
   }
