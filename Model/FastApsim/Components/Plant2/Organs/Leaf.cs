...
public class Leaf : BaseOrganWithLiveDead, AboveGround
   ...
   [Ref("parent(Plant).Population")]   Population Population;
   [Ref("parent(Plant).Phenology")]  Phenology Phenology;
   [Ref("*")]                       Instance[] Children;
   [Ref("NodeInitiationRate")]   Function NodeInitiationRate;
   [Ref("NodeAppearanceRate")]   Function NodeAppearanceRate;
   [Ref("FrostFraction")]         Function FrostFraction;
   [Ref("BranchingRate")]        Function BranchingRate;
   
   [Ref("MaxArea")] Function MaxArea;
   [Ref("GrowthDuration")] Function GrowthDuration;
   [Ref("LagDuration")] Function LagDuration;
   [Ref("SenescenceDuration")] Function SenescenceDuration;
   [Ref("SpecificLeafArea")] Function SpecificLeafArea;
   [Ref("MaximumNConc")] Function MaximumNConc;
   [Ref("MinimumNConc")] Function MinimumNConc;
   [Ref("StructuralNConc")] Function StructuralNConc;
   [Ref("InitialNConc")] Function InitialNConc;
   [Ref("Height")]       Function HeightModel;

   [Ref("PartitionFraction")] Function PartitionFraction;
   [Ref("ExpansionStress")] Function ExpansionStress;

   [Ref("ExtinctionCoeff")] Function ExtinctionCoeff;
