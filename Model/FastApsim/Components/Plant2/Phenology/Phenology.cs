...
public class Phenology : Instance
   ...
   public Phase CurrentPhase
      ...
      set
         ...
         CurrentPhaseIndex = IndexOf(value.Name);
         ...
         if (PhaseChanged != null)
            ...
            MyPaddock.Publish(CurrentPhase.Start, null);
            }
         }
      }
   ...
   public bool Between(String Start, String End)
      {
      int StartPhaseIndex = Array.IndexOf(Phases, PhaseStartingWith(Start));
      int EndPhaseIndex = Array.IndexOf(Phases, PhaseStartingWith(End));
      int CurrentPhaseIndex = Array.IndexOf(Phases, CurrentPhase);
