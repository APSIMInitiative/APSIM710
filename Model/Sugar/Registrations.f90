module Registrations
   ...
   contains
      ...
      subroutine doRegistrations(id)
         ...
         id%dummy = add_reg(respondToGetReg, 'canefw', floatTypeDDML, 'g/m^2', 'Sugar cane fresh weight')
         ...
         id%dummy = add_reg(respondToGetReg, 'swdef_pheno', floatTypeDDML, '0-1', 'Sugar water stress factor on phenology')
         id%dummy = add_reg(respondToGetReg, 'swdef_photo', floatTypeDDML, '0-1', 'Sugar water stress factor on photosynthesis')
         id%dummy = add_reg(respondToGetReg, 'swdef_expan', floatTypeDDML, '0-1', 'Sugar water stress factor on cell expansion')
         id%dummy = add_reg(respondToGetReg, 'swdef_stalk', floatTypeDDML, '0-1', '')
         id%dummy = add_reg(respondToGetReg, 'nfact_photo', floatTypeDDML, '0-1', 'Sugar Nitrogen stress factor on photosynthesis')
         ...
         id%dummy = add_reg(respondToGetReg, 'fasw', floatTypeDDML, '0-1', '')
         id%dummy = add_reg(respondToGetReg, 'esw', floatArrayTypeDDML, 'mm', '')
         id%dummy = add_reg(respondToGetReg, 'cane_dmf', floatTypeDDML, '0-1', '')
         id%dummy = add_reg(respondToGetReg, 'oxdef_photo', floatTypeDDML, '0-1', '')
