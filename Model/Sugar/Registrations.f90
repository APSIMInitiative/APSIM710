module Registrations
   ...
   contains
      ...
      subroutine doRegistrations(id)
         ...
         id%dummy = add_reg(respondToGetReg, 'rootdepth', floatTypeDDML, 'mm', 'Sugar depth of roots')
         id%dummy = add_reg(respondToGetReg, 'coverlive', floatTypeDDML, '', '')
         id%dummy = add_reg(respondToGetReg, 'radn_int', floatTypeDDML, 'mj/m2', '')
         id%dummy = add_reg(respondToGetReg, 'CoverTotal', floatTypeDDML, '', '')
         id%dummy = add_reg(respondToGetReg, 'lai_sum', floatTypeDDML, '', '')
         id%dummy = add_reg(respondToGetReg, 'LAITotal', floatTypeDDML, '', 'Sugar total leaf area index (green and senesced)')
         ...
         id%dummy = add_reg(respondToGetReg, 'GrowthRate', floatTypeDDML, 'g/m^2', 'Sugar daily biomass production')
         ...
         id%dummy = add_reg(respondToGetReg, 'AboveGroundLiveN', floatTypeDDML, 'g/m^2', 'Sugar green biomass N')
         id%dummy = add_reg(respondToGetReg, 'n_green', floatArrayTypeDDML, 'g/m^2', 'Sugar green N for all parts')
         id%dummy = add_reg(respondToGetReg, 'LiveN', floatTypeDDML, 'g/m^2', '')
         id%dummy = add_reg(respondToGetReg, 'DeadN', floatTypeDDML, 'g/m^2', '')
         ...
         id%dummy = add_reg(respondToGetReg, 'nstressphoto', floatTypeDDML, '', 'Sugar Nitrogen stress factor on photosynthesis')
         ...
         id%dummy = add_reg(respondToGetReg, 'AboveGroundN', floatTypeDDML, 'kg/ha', '')
         id%dummy = add_reg(respondToGetReg, 'no3_tot', floatTypeDDML, 'g/m^2', '')
         id%dummy = add_reg(respondToGetReg, 'RootNDemand', floatTypeDDML, 'g/m^2', 'Sugar nitrogen demand')
