...
namespace CMPServices
{
    ...
    public class TEntityList
    {
        ...
        //==============================================================================
        /// <summary>
        /// Swap the positions of two entities in the list
        /// </summary>
        /// <param name="indexA">1-based list index</param>
        /// <param name="indexB">1-based list index</param>
        //==============================================================================
        public void swap(int indexA, int indexB)
        {
            if ((indexA != indexB) && (indexA > 0) && (indexB > 0) &&
             (indexA <= infoList.Count) && (indexB <= infoList.Count))
            {
                TIDSpec temp = infoList[indexA - 1];
                infoList[indexA - 1] = infoList[indexB - 1];
                infoList[indexB - 1] = temp;
            }
        }
    }
}
