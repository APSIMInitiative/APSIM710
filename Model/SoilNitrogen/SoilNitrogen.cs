...
public class SoilNitrogen
{
    ...
    {
        // performs the initial checks and calculations
    ...
    private void CheckParams()  // Could do checking of the parameters here....
    {
        Console.WriteLine();
    ...
    { // no need for this, values should be an input
        //string value;
