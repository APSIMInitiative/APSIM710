...
namespace ApsimFile
{
    public class SoilDataTable
    {
        ...
        public static XmlNode TableToXML(DataTable Table, ProgressNotifier Notifier)
        {
        ...
        public static DataTable XMLToTable(XmlNode Xml, List<string> XMLPaths)
        {
            // --------------------------------------------------------------
            ...
            if (XMLPaths == null)
            {
                ...
                XmlHelper.FindAllRecursivelyByType(Xml, "soil", ref Nodes);
                foreach (XmlNode SoilNode in Nodes)
                    XMLPaths.Add(XmlHelper.FullPath(SoilNode));
        ...
        private static void CreateTableFromData(XmlNode Data, DataTable Table, string ChildPath, ref int Row)
        {
            // --------------------------------------------------------------
