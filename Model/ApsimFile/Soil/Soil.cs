            ...
            get
            {
                foreach (Sample Sample in Samples)
                {
                    if (MathUtility.ValuesInArray(Sample.NO3ppm(this)))
                        return Map(Sample.NO3ppm(this), Sample.Thickness, Thickness, MapType.Concentration, 1.0 /*Sample.NO3ppm(this).Last()*/);
                }
                return null;
            }
        }
            ...
            get
            {
                foreach (Sample Sample in Samples)
                {
                    if (MathUtility.ValuesInArray(Sample.NH4))
                        return Map(Sample.NH4ppm(this), Sample.Thickness, Thickness, MapType.Concentration, 0.2);
                }
                return null;
            }
        }
