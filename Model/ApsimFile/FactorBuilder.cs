...
namespace ApsimFile
{
	...
	public class Factor
	{
		...
		private static string simulationName (bool saveExtraInfoInFilename, string rootName, SortedDictionary<string, string> factorsList, int counter, int totalCount)
		{
