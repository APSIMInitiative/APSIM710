...
using System.Collections.Generic;
    ...
    public class SlurryTank
    {
        ...
        public void OnAddSlurry(ManureType input)
        {
            ...
            Console.WriteLine(input.WhereTo);
            if (input.WhereTo.Equals(TankName))
            {
            ...
            Console.Out.WriteLine("Leaving OnAddSlurry in Slurry Tank");
        ...
        public void OnProcess()
        {
            ...
            Console.Out.WriteLine("Entered OnProcess in Slurry Tank");
