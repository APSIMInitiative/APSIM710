...
private static void doLINUX ()
{
   ...
   if (JobID != -1)
   {
      ...
      string LogFileName = "/tmp/Apsim7.9-r" + revision + ".linux.txt";
      StreamWriter Log = new StreamWriter(LogFileName);
      ...
      // Set some environment variables.
      System.Environment.SetEnvironmentVariable("JobID", JobID.ToString());
      System.Environment.SetEnvironmentVariable("PatchFileName", "Apsim7.9-r" + revision);
      System.Environment.SetEnvironmentVariable("PatchFileNameShort", "Apsim7.9-r" + revision);
      ...
      try
      {
      Run("Uploading details...", "/usr/bin/curl", " -T " + LogFileName + " -u bob:seg ftp://bob.apsim.info/Files/Apsim7.9-r" + revision + ".linux.txt");
      Run("Updating details...", Path.Combine(APSIMDir, "Model/UpdateFieldInDB.exe"),
                               "linuxDetailsFileName http://bob.apsim.info/files/Apsim7.9-r" + revision + ".linux.txt");
      }
      catch (Exception e)
      {
