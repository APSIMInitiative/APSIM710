        ...
        try
        {
            ...
            if (System.Environment.MachineName.ToUpper() == "BOB")
            {
                ...
                try
                {
                    ...
                    string revFileName = "C:\\inetpub\\wwwroot\\Files\\Apsim7.9-r" + TipRevisionNumber.ToString() + ".binaries.WINDOWS.INTEL.exe";
                    ...
                    revFileName = "C:\\inetpub\\wwwroot\\Files\\Apsim7.9-r" + TipRevisionNumber.ToString() + ".binaries.WINDOWS.X86_64.exe";
