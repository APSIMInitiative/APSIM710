...
namespace CSUserInterface
   ...
   public class InitNitrogenUI : BaseView
      ...
      private Steema.TeeChart.Tools.DragPoint NO3KgDragPoint;
      private Steema.TeeChart.Tools.DragPoint NH4KgDragPoint;
      private Steema.TeeChart.Tools.DragPoint NO3PPMDragPoint;
      private Steema.TeeChart.Tools.DragPoint NH4PPMDragPoint;
      ...
      private void InitializeComponent()
         ...
         this.NO3KgDragPoint = new Steema.TeeChart.Tools.DragPoint();
         this.NH4KgDragPoint = new Steema.TeeChart.Tools.DragPoint();
         this.NO3PPMDragPoint = new Steema.TeeChart.Tools.DragPoint();
         this.NH4PPMDragPoint = new Steema.TeeChart.Tools.DragPoint();
         ...
         // MyHelpLabel
         // 
         this.MyHelpLabel.Size = new System.Drawing.Size(908, 16);
         // 
         // panel1
         // 
         ...
         this.panel1.Size = new System.Drawing.Size(908, 749);
        ...
        "Nitrogen (kg/ha)"};
         ...
         this.NitrogenChart.BackColor = System.Drawing.SystemColors.Window;
        ...
        ""};
         ...
         this.NitrogenChart.Size = new System.Drawing.Size(586, 749);
         // 
         // 
         // 
         // 
         ...
         this.NitrogenChart.Tools.Add(this.NO3KgDragPoint);
         this.NitrogenChart.Tools.Add(this.NH4KgDragPoint);
         this.NitrogenChart.Tools.Add(this.NO3PPMDragPoint);
         this.NitrogenChart.Tools.Add(this.NH4PPMDragPoint);
         // 
         // 
         // 
         // 
         ...
         this.No3KgHaLine.Pointer.Visible = true;
         ...
         this.Nh4KgHaLine.Pointer.Visible = true;
         ...
         this.No3PpmLine.Pointer.Visible = true;
         ...
         this.Nh4PpmLine.Pointer.Visible = true;
         ...
         // NO3KgDragPoint
         // 
         this.NO3KgDragPoint.Cursor = System.Windows.Forms.Cursors.SizeWE;
         this.NO3KgDragPoint.Series = this.No3KgHaLine;
         this.NO3KgDragPoint.Style = Steema.TeeChart.Tools.DragPointStyles.X;
         this.NO3KgDragPoint.Drag += new Steema.TeeChart.Tools.DragPointEventHandler(this.OnNo3KgDragPoint);
         // 
         // NH4KgDragPoint
         // 
         this.NH4KgDragPoint.Cursor = System.Windows.Forms.Cursors.SizeWE;
         this.NH4KgDragPoint.Series = this.Nh4KgHaLine;
         this.NH4KgDragPoint.Style = Steema.TeeChart.Tools.DragPointStyles.X;
         this.NH4KgDragPoint.Drag += new Steema.TeeChart.Tools.DragPointEventHandler(this.OnNH4KgDragPoint);
         // 
         // NO3PPMDragPoint
         // 
         this.NO3PPMDragPoint.Cursor = System.Windows.Forms.Cursors.SizeWE;
         this.NO3PPMDragPoint.Series = this.No3PpmLine;
         this.NO3PPMDragPoint.Style = Steema.TeeChart.Tools.DragPointStyles.X;
         this.NO3PPMDragPoint.Drag += new Steema.TeeChart.Tools.DragPointEventHandler(this.OnNO3PPMDragPoint);
         // 
         // NH4PPMDragPoint
         // 
         this.NH4PPMDragPoint.Cursor = System.Windows.Forms.Cursors.SizeWE;
         this.NH4PPMDragPoint.Series = this.Nh4PpmLine;
         this.NH4PPMDragPoint.Style = Steema.TeeChart.Tools.DragPointStyles.X;
         this.NH4PPMDragPoint.Drag += new Steema.TeeChart.Tools.DragPointEventHandler(this.OnNH4PPMDragPoint);
         // 
         // LeftHandPanel
         // 
         ...
         this.LeftHandPanel.Size = new System.Drawing.Size(322, 749);
         ...
         this.Grid.Sheets.AddRange(new FarPoint.Win.Spread.SheetView[] {
            this.NitrogenGrid});
         this.Grid.Size = new System.Drawing.Size(322, 681);
         ...
         this.NitrogenGrid.Columns.Get(1).CellType = numberCellType9;
         ...
         this.NitrogenGrid.Columns.Get(2).CellType = numberCellType10;
         ...
         this.NitrogenGrid.Columns.Get(3).CellType = numberCellType11;
         ...
         this.NitrogenGrid.Columns.Get(4).CellType = numberCellType12;
      ...
      private void OnNo3KgDragPoint(Steema.TeeChart.Tools.DragPoint sender, int index)
         {
         double NewValue = No3KgHaLine.XValues[index];
         NitrogenGrid.Cells[index, 1].Value = NewValue;
         }

      private void OnNH4KgDragPoint(Steema.TeeChart.Tools.DragPoint sender, int index)
         {
         double NewValue = Nh4KgHaLine.XValues[index];
         NitrogenGrid.Cells[index, 2].Value = NewValue;
         }

      private void OnNO3PPMDragPoint(Steema.TeeChart.Tools.DragPoint sender, int index)
         {
         double NewValue = No3PpmLine.XValues[index];
         NitrogenGrid.Cells[index, 3].Value = NewValue;
         }

      private void OnNH4PPMDragPoint(Steema.TeeChart.Tools.DragPoint sender, int index)
         {
         double NewValue = Nh4PpmLine.XValues[index];
         NitrogenGrid.Cells[index, 4].Value = NewValue;
         }
