...
public class Inhibitor
{
    ...
    // Soil temperature for each layer (oC) from soiltemp
    [Input(IsOptional = true)]
    ...
    private double[] dcd_effect = new double[1];
    [Output]
    [Units("0-1")]
    ...
    /// <summary>
    /// send information about the solute owned by this module
    /// </summary>
    [Event]
    ...
    //string teste = GetName(new { dcd_effect });
    ...
    public void OnInitialised()
    {
        ...
        SoilTemp = new double[dlayer.Length];
    ...
    //[EventHandler()]
    //public void OnInhibitorChanged()
    //{
