...
#End Region
    ...
    Public Function doNutrientReturns(ByVal pdk As LocalPaddockType, ByVal UrineOut_N As Double, ByVal DungNitrogen As Double, ByVal DungDM As Double, ByVal density As Double) As Double 'ByVal paddock As PaddockHolder)
