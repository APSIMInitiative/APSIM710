...
using CSGeneral;
    ...
    public static class ApsimUtil
        ...
        static public double root_proportion(int Layer, double[] Dlayer, double RootDepth)
            ...
            return MathUtility.Divide(depth_of_root_in_layer, Dlayer[au.ci(Layer)], 0.0);
        ...
        */
        ...
        static public void jday_to_day_of_year(Double JulianDay, out int DOY, out int Year)
            ...
            int iJulianDay = (int)Math.Truncate(JulianDay);
            DateTime theday = CSGeneral.DateUtility.JulianDayNumberToDateTime(iJulianDay);
