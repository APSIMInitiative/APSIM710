...
public class VernalisationCW : Instance
   {
   private Plant Plant;
   [Output] private double PhotopEff;
   [Output] private double VernEff;
   ...
   private double VernalisationDays(double MaxT, double MinT, double CrownTemperature, double Snow, double CumulativeVD)
      ...
      if (Plant.Phenology.Between(StartStageForCumulativeVD, EndStageForCumulativeVD))
         {
   ...
   private double VernalisationEffect(double vern_sens, double CumulativeVD, double DeltaCumulativeVD, double MaxVernalisationRequirement)
      ...
      if (Plant.Phenology.Between(StartStageForEffects, EndStageForEffects))
         {
