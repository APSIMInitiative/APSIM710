...
public class Root : Organ, BelowGround
   {
   ...
   public override Biomass Live
      ...
      get
         ...
         foreach (Biomass B in LayerLive)
            {
            Total.StructuralWt += B.StructuralWt;
            Total.NonStructuralWt += B.NonStructuralWt;
            }
         return Total;
         }
      }
   public override Biomass Dead
      ...
      get
         {
         Biomass Total = new Biomass();
         foreach (Biomass B in LayerDead)
            {
            Total.StructuralWt += B.StructuralWt;
            Total.NonStructuralWt += B.NonStructuralWt;
            }
   ...
   [Output] [Units("g/m^2")] double LiveWt { get { return Live.Wt; } }
   [Output] [Units("g/m^2")] double DeadWt { get { return Dead.Wt; } }
