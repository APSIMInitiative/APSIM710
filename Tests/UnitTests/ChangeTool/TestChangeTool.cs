...
public class ChangeToolTest
{
    ...
    {
        ConvertFileToVersion("..\\..\\Files\\Apsim72.apsimoriginal", 23);
        CompareFiles("..\\..\\Files\\Apsim72.apsimconverted", "..\\..\\Files\\Apsim72.apsimoriginaltestconverted");
    }

    [Test]
    public void ToVersion27()
    {
        ConvertFileToVersion("..\\..\\Files\\Apsim73.apsimoriginal", 27);
        CompareFiles("..\\..\\Files\\Apsim73.apsimconverted", "..\\..\\Files\\Apsim73.apsimoriginaltestconverted");
    }
    [Test]
    public void ToVersion29()
    {
        ConvertFileToVersion("..\\..\\Files\\Apsim74.apsimoriginal", 29);
        CompareFiles("..\\..\\Files\\Apsim74.apsimconverted", "..\\..\\Files\\Apsim74.apsimoriginaltestconverted");
    }
}
